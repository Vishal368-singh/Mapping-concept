import {
  ...
  n as n7,
  p as p6
} from "./chunk-RKFQKTS5.js";
import {
  r as r5
} from "./chunk-DLMAXI2L.js";
import {
  A
...
import {
  o as o4
} from "./chunk-PVUHK5FP.js";
import "./chunk-OXO3GGCE.js";
import {
  p as p4
} from "./chunk-OLJI3PYM.js";
import {
  s as s5
...
r([m(h3)], u5.prototype, "georeference", void 0), r([o2("georeference")], u5.prototype, "readGeoreference", null), r([r2("georeference")], u5.prototype, "writeGeoreference", null), r([m({ json: { read: false, write: false } })], u5.prototype, "opacity", void 0), u5 = r([a("esri.layers.support.MediaElementBase")], u5);
...
function P3(t3, e4) {
  const r6 = n3(), o6 = `${V2("media", r6)}.${p5({ type: "blob", blob: t3 })}`;
  return e4.resourceFromPath(o6);
}
r([m()], U3.prototype, "animationOptions", void 0), r([m({ readOnly: true })], U3.prototype, "content", void 0), r([m({ readOnly: true })], U3.prototype, "contentWidth", null), r([m({ readOnly: true })], U3.prototype, "contentHeight", null), r([m(w)], U3.prototype, "image", void 0), r([o2("image", ["url"])], U3.prototype, "readImage", null), r([r2("image")], U3.prototype, "writeImage", null), r([m(g)], U3.prototype, "type", void 0), U3 = r([a("esri.layers.support.ImageElement")], U3);
...
var I3 = class extends p2.LoadableMixin(m3.EsriPromiseMixin(o.EventedAccessor)) {
  ...
  set elements(e4) {
    this._set("elements", n2(e4, this._get("elements"), M4));
  }
  get fullExtent() {
...
var b3 = class extends p3(t2(b(j(S(h))))) {
  constructor(e4) {
    super(e4), this.effectiveSource = null, this.georeference = null, this.copyright = null, this.operationalLayerType = "MediaLayer", this.spatialReference = null, this.type = "media", this._debouncedSaveOperations = k((async (e5, r6, o6) => {
      const { save: t3, saveAs: s6 } = await import("./mediaLayerUtils-ON4OED7G.js");
      switch (e5) {
        case A.SAVE:
          return t3(this, r6);
        case A.SAVE_AS:
  ...
  async _doLoad(e4) {
    ...
    const i3 = c3(t3) ? new I3({ elements: new V([t3]) }) : t3;
  ...
  castSource(e4) {
    return e4 ? Array.isArray(e4) ? new I3({ elements: new V(e4) }) : e4 instanceof V ? new I3({ elements: e4 }) : e4 : null;
  }
  readSource(e4, r6, o6) {
...
} } } })], b3.prototype, "source", null), r([s3("source")], b3.prototype, "castSource", null), r([o2("source", ["url"])], b3.prototype, "readSource", null), r([r2("source")], b3.prototype, "writeSource", null), r([m()], b3.prototype, "spatialReference", void 0), r([m({ readOnly: true })], b3.prototype, "type", void 0), b3 = r([a("esri.layers.MediaLayer")], b3);
var E3 = b3;
export {
  E3 as default
};
//# sourceMappingURL=MediaLayer-4ONWJK4M.js.map
