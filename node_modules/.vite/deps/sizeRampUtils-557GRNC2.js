import {
  g
} from "./chunk-M5RTNHBO.js";
import "./chunk-HDFVEO2E.js";
import "./chunk-FTGYCI5M.js";
...
async function H(e2, t2, o, i3) {
  const n2 = (await import("./visualVariableUtils-7QLZWGIY.js")).getSizeRangeAtScale(e2, o, i3), r2 = n2 && O(n2);
  if (!n2 || !r2) return;
...
async function G2(e2, t2, l3, o, i3) {
  const { getSize: n2 } = await import("./visualVariableUtils-7QLZWGIY.js");
...
//# sourceMappingURL=sizeRampUtils-557GRNC2.js.map
