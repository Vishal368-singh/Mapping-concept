import {
  x
} from "./chunk-FCTU4PIJ.js";
import {
  t as t2
} from "./chunk-YBWWL424.js";
import {
  F,
  e as e3,
  e2 as e5,
  ...
  ne,
  t
} from "./chunk-4VGXYK4J.js";
import "./chunk-RIB5GFVA.js";
import "./chunk-OG7E7GTZ.js";
import "./chunk-ROF2AMCT.js";
import "./chunk-YWVVUIPJ.js";
import "./chunk-ACRQF5CF.js";
import "./chunk-R62BLGYS.js";
import "./chunk-YLMHRZGV.js";
import "./chunk-LIBRCYZO.js";
import "./chunk-PWMG7PVD.js";
import "./chunk-I3EB2Q35.js";
import "./chunk-MPRKLRX3.js";
import "./chunk-H7MZD3K2.js";
import "./chunk-Z5JR5AC4.js";
...
var e7 = () => c2({ action: () => import("./calcite-action-ZLRA67TC.js") });
...
var f4 = class extends O {
  ...
  loadDependencies() {
    return Promise.all([e7(), c2({ action: () => import("./calcite-action-ZLRA67TC.js"), "action-bar": () => import("./calcite-action-bar-DJUUKBJS.js"), "action-group": () => import("./calcite-action-group-GAYMOBDD.js"), "flow-item": () => import("./calcite-flow-item-RIIX6FIB.js") })]);
  }
  render() {
...
r([m()], f4.prototype, "flowItems", void 0), r([m(), e2("esri/widgets/Features/t9n/Features")], f4.prototype, "messages", void 0), r([m()], f4.prototype, "closed", void 0), r([m()], f4.prototype, "closable", void 0), r([m()], f4.prototype, "selectLastFlowItem", void 0), f4 = r([a("esri.widgets.Features.FeaturesDrillIn")], f4);
...
var l3 = (t5) => {
  ...
  if (g2 === n7.id) return f5(u2).catch(f);
...
async function f5(t5, o5) {
  ...
  const f6 = s4.scale / c8, m5 = l4?.geometry ?? t5.selectedFeature?.geometry ?? n8, v2 = null != m5 && "point" === m5.type && await w(l4 ?? a8, s4);
...
var z = class extends i4(c5) {
  constructor(e11) {
    super(e11), this._pendingPromises = new t2(), this._fetchFeaturesController = null, this._highlightPromises = { "highlight-active-feature": null, "highlight-selected-feature": null }, this._selectedClusterFeature = null, this.actions = new i5(), this.activeFeature = null, this.autoCloseEnabled = false, this.browseClusterEnabled = false, this.content = null, this.defaultPopupTemplateEnabled = false, this.featurePage = null, this.featuresPerPage = 20, this.featureMenuOpen = false, this.featureMenuTitle = null, this.featureViewModelAbilities = null, this.featureViewModels = [], this.highlightEnabled = true, this.includeDefaultActions = true, this.initialDisplayMode = "feature", this.selectedClusterBoundaryFeature = new d2({ symbol: new m2({ outline: { width: 1.5, color: "cyan" }, style: "none" }) }), this.title = null, this.updateLocationEnabled = false, this.view = null, this.visible = false, this.zoomFactor = 4, this.zoomToLocation = null, this._debouncedLocationUpdate = k((async (e12) => {
      ...
      if (i6 && "mesh" !== i6 && t5 && s4 && this.selectedFeature) if ("point" !== i6) try {
        ...
        i7 = O2(i7, t5), G || (G = await Promise.all([await import("./intersectsOperator-BUPXXRRZ.js"), await import("./proximityOperator-GV4LFHK7.js")]));
        const [a8, n8] = G;
        if (!a8.execute(i7, s4)) {
      ...
      else this.location = n3(this.selectedFeature.geometry) ?? s4;
    }));
  }
  initialize() {
  ...
  async _selectedFeatureChange(e11) {
    ...
    } else this.location = n3(e11.geometry);
  }
...
var H2 = class extends n4(O) {
  constructor(e11, i6) {
    ...
    }), (() => this._setContentFromFeatureWidget())), l((() => this.viewModel?.featureViewModels), (() => this._featureMenuViewportScrollTop())), l((() => this._drillInFlowItems.length), (() => this._focusFlowItemNode())), this._drillInWidget.on("close", (() => this.close())), this._drillInWidget.on("exit", (() => this._destroyDrillInFlowItemWidgets())), this._drillInWidget.on("open-feature", (({ feature: e12 }) => this._openRelatedFeature(e12))), this._drillInWidget.on("zoom-to-feature", (({ featureWidget: e12 }) => f5(this.viewModel, e12)))]);
  }
  loadDependencies() {
    return Promise.all([e7(), c2({ action: () => import("./calcite-action-ZLRA67TC.js"), "action-bar": () => import("./calcite-action-bar-DJUUKBJS.js"), "action-group": () => import("./calcite-action-group-GAYMOBDD.js"), button: () => import("./calcite-button-4IPXP4IJ.js"), icon: () => import("./calcite-icon-JQPP5WAE.js"), flow: () => import("./calcite-flow-HKNKLJKX.js"), "flow-item": () => import("./calcite-flow-item-RIIX6FIB.js"), list: () => import("./calcite-list-XFVCKEJA.js"), "list-item": () => import("./calcite-list-item-DSNVAE4G.js"), "list-item-group": () => import("./calcite-list-item-group-DVZ3XYRX.js"), loader: () => import("./calcite-loader-K4VGO2P2.js") })]);
  }
  destroy() {
...
var D2 = class extends O {
  ...
  destroy() {
    this._dockAction.destroy(), this._featuresWidget && (this._featuresWidget.viewModel = new z(), this._featuresWidget.destroy()), this._focusAbortController?.abort();
  }
  ...
  _calculateAutoAlignment(e11) {
    ...
    const a8 = o5 ? window.getComputedStyle(o5, null) : null, d4 = a8 ? l4(a8.getPropertyValue("max-height")) : 0, c8 = a8 ? l4(a8.getPropertyValue("height")) : 0, { height: h4, width: u2 } = i6.getBoundingClientRect(), p4 = u2 + t5, g2 = Math.max(h4, d4, c8) + t5, v2 = this._isOutsideView({ popupHeight: g2, popupWidth: p4, screenLocation: s4, side: "right", view: r3 }), m5 = this._isOutsideView({ popupHeight: g2, popupWidth: p4, screenLocation: s4, side: "left", view: r3 }), f6 = this._isOutsideView({ popupHeight: g2, popupWidth: p4, screenLocation: s4, side: "top", view: r3 }), w2 = this._isOutsideView({ popupHeight: g2, popupWidth: p4, screenLocation: s4, side: "bottom", view: r3 });
    return m5 ? f6 ? "bottom-right" : "top-right" : v2 ? f6 ? "bottom-left" : "top-left" : f6 ? w2 ? "top-center" : "bottom-center" : "top-center";
  }
...
//# sourceMappingURL=Popup-CKODFNHO.js.map
