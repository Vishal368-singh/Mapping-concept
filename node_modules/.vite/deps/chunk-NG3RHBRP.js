...
async function i() {
  if (!o()) {
    const [n2, o2] = await Promise.all([import("./OperatorGeodeticArea-QIWX6SSF.js"), import("./ProjectionTransformation-QMVDRBGR.js").then(((e2) => e2.aG)).then((({ injectPe: e2 }) => e2)), _()]);
...
async function m() {
  if (!c()) {
    const [e2] = await Promise.all([import("./apiConverter-U4MJGQU7.js"), i()]);
...
//# sourceMappingURL=chunk-NG3RHBRP.js.map
