...
} } } })], a3.prototype, "extent", void 0), r([m2({ type: ["view", "edit"], json: { write: true } })], a3.prototype, "mode", void 0), r([m2({ type: String, json: { read: c.read, write: c.write } })], a3.prototype, "originPosition", void 0), r([m2({ type: Number, json: { write: { overridePolicy() {
  return { enabled: "view" === this.mode };
} } } })], a3.prototype, "tolerance", void 0), a3 = n = r([a2("esri.rest.support.QuantizationParameters")], a3);
...
r([m2({ json: { write: true } })], R2.prototype, "aggregateIds", void 0), r([m2({ type: Boolean, json: { write: true } })], R2.prototype, "cacheHint", void 0), r([m2({ type: Boolean, json: { default: false, write: true } })], R2.prototype, "compactGeometryEnabled", void 0), r([m2({ json: { write: true } })], R2.prototype, "datumTransformation", void 0), r([s("datumTransformation")], R2.prototype, "castDatumTransformation", null), r([m2({ type: Boolean, json: { default: false, write: true } })], R2.prototype, "defaultSpatialReferenceEnabled", void 0), r([m2({ type: Number, json: { write: true } })], R2.prototype, "distance", void 0), r([m2({ type: R, json: { write: true } })], R2.prototype, "dynamicDataSource", void 0), r([m2({ type: String, json: { write: true } })], R2.prototype, "formatOf3DObjects", void 0), r([m2({ type: [p], json: { write: { enabled: true, overridePolicy() {
  return { enabled: null != this.fullText && this.fullText.length > 0 };
} } } })], R2.prototype, "fullText", void 0), r([m2({ type: String, json: { write: true } })], R2.prototype, "gdbVersion", void 0), r([m2({ types: l2, json: { read: f2, write: true } })], R2.prototype, "geometry", void 0), r([m2({ type: Number, json: { write: true } })], R2.prototype, "geometryPrecision", void 0), r([m2({ type: [String], json: { write: true } })], R2.prototype, "groupByFieldsForStatistics", void 0), r([m2({ type: String, json: { write: true } })], R2.prototype, "having", void 0), r([m2({ type: Date })], R2.prototype, "historicMoment", void 0), r([r2("historicMoment")], R2.prototype, "writeHistoricMoment", null), r([m2({ type: Number, json: { write: true } })], R2.prototype, "maxAllowableOffset", void 0), r([m2({ type: Number, cast: (t) => t < 1 ? 1 : t > R2.MAX_MAX_RECORD_COUNT_FACTOR ? R2.MAX_MAX_RECORD_COUNT_FACTOR : t, json: { write: { overridePolicy: (t) => ({ enabled: t > 1 }) } } })], R2.prototype, "maxRecordCountFactor", void 0), r([m2({ type: ["xyFootprint"], json: { write: true } })], R2.prototype, "multipatchOption", void 0), r([m2({ type: Number, json: { read: { source: "resultRecordCount" } } })], R2.prototype, "num", void 0), r([m2({ json: { write: true } })], R2.prototype, "objectIds", void 0), r([m2({ type: [String], json: { write: true } })], R2.prototype, "orderByFields", void 0), r([m2({ type: [String], json: { write: true } })], R2.prototype, "outFields", void 0), r([m2({ type: f, json: { name: "outSR", write: true } })], R2.prototype, "outSpatialReference", void 0), r([m2({ type: [p2], json: { write: { enabled: true, overridePolicy() {
  return { enabled: null != this.outStatistics && this.outStatistics.length > 0 };
} } } })], R2.prototype, "outStatistics", void 0), r([m2({ json: { write: true } })], R2.prototype, "parameterValues", void 0), r([r2("parameterValues")], R2.prototype, "writeParameterValues", null), r([m2({ type: _, json: { write: true } })], R2.prototype, "pixelSize", void 0), r([m2({ type: a3, json: { write: true } })], R2.prototype, "quantizationParameters", void 0), r([m2({ type: [Object], json: { write: true } })], R2.prototype, "rangeValues", void 0), r([m2({ type: String, json: { read: { source: "relationParam" }, write: { target: "relationParam", overridePolicy() {
...
//# sourceMappingURL=chunk-U5KBQRKK.js.map
