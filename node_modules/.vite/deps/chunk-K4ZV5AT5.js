...
r([m({ type: String, json: { write: true } })], n3.prototype, "description", void 0), r([m({ type: String, json: { write: true } })], n3.prototype, "label", void 0), r([m(y2)], n3.prototype, "symbol", void 0), r([m({ type: [l3], json: { type: [[String]], read: { reader: (r4) => r4 ? r4.map(((r5) => new l3({ value: r5[0], value2: r5[1], value3: r5[2] }))) : null }, write: { writer: (r4, e2) => {
  const t = [];
  for (const s3 of r4) {
...
//# sourceMappingURL=chunk-K4ZV5AT5.js.map
