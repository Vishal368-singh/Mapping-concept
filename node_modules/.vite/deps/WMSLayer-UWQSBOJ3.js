...
var Y = class extends p(c(f2(t2(b2(j(S(h))))))) {
  ...
  load(e) {
    ...
    return this.addResolvingPromise(this.loadFromPortal({ supportedTypes: ["WMS"] }, e).catch(a3).then((() => this._fetchService(t4))).then((() => this._checkLayerValidity()))), Promise.resolve(this);
  }
