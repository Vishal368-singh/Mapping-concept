...
var _InputMessage = class _InputMessage extends LitElement {
  ...
  renderIcon(iconName) {
    if (iconName) {
      return html`<calcite-icon class="calcite-input-message-icon" .flipRtl=${this.iconFlipRtl} .icon=${iconName} scale=s></calcite-icon>`;
    }
  }
};
...
@esri/calcite-components/dist/components/calcite-input-message/customElement.js:
  ...
  v3.2.1 *)
*/
//# sourceMappingURL=chunk-SJMLKOLL.js.map
