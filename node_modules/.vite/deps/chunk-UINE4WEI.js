...
function a2(t3, r4, n4, s5) {
  if (r4.type === e3.OPEN_PORT) return void t3.postMessage(r4, [r4.port]);
  if (r4.type !== e3.INVOKE && r4.type !== e3.RESPONSE) return void t3.postMessage(r4);
  let f2;
  if (o2(n4) ? (f2 = u2(n4.transferList), r4.data = n4.result) : (f2 = u2(s5), r4.data = n4), f2) {
    if (has("ff")) {
      for (const n5 of f2) if ("byteLength" in n5 && n5.byteLength > 267386880) {
        ...
        switch (r4.type) {
          case e3.INVOKE:
            throw n6;
          case e3.RESPONSE:
            return void a2(t3, { type: e3.RESPONSE, jobId: r4.jobId, error: i(n6) });
        }
      }
    }
    t3.postMessage(r4, f2);
...
function t2(t3, r4) {
  return new Proxy({}, { get: (e5, i3, s5) => (...e6) => {
    let s6, o3;
    const a3 = e6[e6.length - 1];
    n2(a3) && (s6 = a3.signal, o3 = a3.transferList, e6.pop());
    return t3.apply(r4 ? `${r4}.${i3.toString()}` : i3.toString(), e6, { transferList: o3, signal: s6 });
  } });
}
function n2(t3) {
...
var r3 = { statsWorker: () => import("./statsWorker-MYTYWGNK.js"), geometryEngineWorker: () => import("./geometryEngineWorker-ZCF6GRIX.js"), arcadeGeometryOperatorsWorker: () => import("./operatorsWorker-QJAZ2TY4.js"), CSVSourceWorker: () => import("./CSVSourceWorker-OZWEC3H5.js"), EdgeProcessingWorker: () => import("./EdgeProcessingWorker-M4BTPUZX.js"), ElevationSamplerWorker: () => import("./ElevationSamplerWorker-YAXZ37ZP.js"), FeatureServiceSnappingSourceWorker: () => import("./FeatureServiceSnappingSourceWorker-K77ISAGP.js"), GeoJSONSourceWorker: () => import("./GeoJSONSourceWorker-Z27RTM54.js"), LercWorker: () => import("./LercWorker-JS2DQVFV.js"), MemorySourceWorker: () => import("./MemorySourceWorker-XZV347JH.js"), PBFDecoderWorker: () => import("./PBFDecoderWorker-75ZBWIDI.js"), FeaturePipelineWorker: () => import("./FeaturePipelineWorker-RPGVN3DJ.js"), PointCloudWorker: () => import("./PointCloudWorker-M62OBGQD.js"), RasterWorker: () => import("./RasterWorker-VGSMTMTB.js"), SceneLayerSnappingSourceWorker: () => import("./SceneLayerSnappingSourceWorker-5GBTML42.js"), SceneLayerWorker: () => import("./SceneLayerWorker-EBBZKTLQ.js"), WFSSourceWorker: () => import("./WFSSourceWorker-2M5BE2XP.js"), WorkerTileHandler: () => import("./WorkerTileHandler-KMN6KMXI.js"), Lyr3DWorker: () => import("./Lyr3DWorker-QSHMP4XQ.js"), Feature3DPipelineWorker: () => import("./Feature3DPipelineWorker-MM7YSMHQ.js"), TextureCompressionWorker: () => import("./TextureCompressionWorker-NAGMP3E5.js") };

// node_modules/@arcgis/core/core/workers/RemoteClient.js
var { CLOSE: M, ABORT: k, INVOKE: y, RESPONSE: j, OPEN_PORT: I, ON: J } = e3;
var w = 2;
var O2 = class {
  constructor(e5) {
...
var _E = class _E {
  ...
  constructor(e5, s5, t3, o3) {
    this._port = e5, this._jobQueue = t3, this._lowPriorityJobQueue = o3, this._outJobs = /* @__PURE__ */ new Map(), this._inJobs = /* @__PURE__ */ new Map(), this._invokeQueue = new O2(((e6) => this._onInvokeMessage(e6))), this._client = s5.client, this._onMessage = this._onMessage.bind(this), this._channel = s5.channel, this._schedule = s5.schedule, this._port.addEventListener("message", this._onMessage), this._port.start();
  }
  close() {
  ...
  invoke(e5, s5, t3) {
    return this.apply(e5, [s5], t3);
  }
  apply(e5, t3, o3) {
    const a3 = o3?.signal, h = o3?.transferList;
    if (!this._port) return Promise.reject(new s(r2, `Cannot call invoke('${e5}'), port is closed`, { methodName: e5, data: t3 }));
    const c4 = s4();
    return new Promise(((s5, o4) => {
      ...
      this._outJobs.set(c4, _), this._post({ type: y, jobId: c4, methodName: e5, abortable: null != a3 }, t3, h);
    }));
  }
  ...
  on(e5, s5) {
    ...
    return this._port.postMessage({ type: e3.ON, eventType: e5, port: t3.port2 }, [t3.port2]), t3.port1.addEventListener("message", n4), t3.port1.start(), e((() => {
  ...
  _processWork() {
    ...
    if (!e5) return;
    const { methodName: s5, data: t3, invokeOptions: o3, resolver: n4 } = e5;
    this.apply(s5, t3, o3).then(((e6) => n4.resolve(e6))).catch(((e6) => n4.reject(e6)));
  }
  _close() {
  ...
  _onAbortMessage(e5) {
    const s5 = this._inJobs, t3 = e5.jobId, o3 = s5.get(t3);
    this._invokeQueue.push(e5), o3 && (o3.controller && o3.controller.abort(), s5.delete(t3));
  }
  _onCloseMessage() {
  ...
  _onInvokeMessage(e5) {
    const { methodName: s5, jobId: t3, data: o3 = [], abortable: n4 } = e5, i3 = n4 ? new AbortController() : null, r4 = this._inJobs;
    let l2, c4 = this._client, p = c4[s5];
    try {
      if (!p && s5 && s5.includes(".")) {
        const e6 = s5.split(".");
        for (let s6 = 0; s6 < e6.length - 1; s6++) c4 = c4[e6[s6]], p = c4[e6[s6 + 1]];
      }
    ...
    S(l2) ? (r4.set(t3, { controller: i3, promise: l2 }), l2.then(((e6) => {
      r4.has(t3) && (r4.delete(t3), this._post({ type: j, jobId: t3 }, e6));
    }), ((e6) => {
      r4.has(t3) && (r4.delete(t3), b(e6) || this._post({ type: j, jobId: t3, error: i(e6 || { message: `Error encountered at method ${s5}` }) }));
  ...
  _onOnMessage(e5) {
    const { port: s5 } = e5, o3 = this._client.on(e5.eventType, ((e6) => {
      ...
      const t3 = f(e6);
      t3?.type === e3.CLOSE && (n4.remove(), o3.remove(), s5.close());
    }));
  }
  _onResponseMessage(e5) {
    const { jobId: t3, error: o3, data: i3 } = e5, r4 = this._outJobs;
    if (!r4.has(t3)) return;
    const l2 = r4.get(t3);
    r4.delete(t3), this._processWork(), l(l2.abortHandle), o3 ? l2.reject(s.fromJSON(JSON.parse(o3))) : l2.resolve(i3);
  }
  _post(e5, s5, t3) {
    return a2(this._port, e5, s5, t3);
  }
};
_E.kernelInfo = { buildDate: a, fullVersion: r, revision: e2 };
...
var c3 = class {
  ...
  open(e5, s5) {
    return new Promise(((i3, n4) => {
      ...
      for (let o3 = 0; o3 < e5.length; ++o3) {
        const r5 = e5[o3];
        S(r5) ? this._clientPromises[o3] = r5.then(((e6) => (this._clients[o3] = new E(e6, s5, this._ongoingJobsQueue, this._ongoingLowPriorityJobsQueue), l2(i3), this._clients[o3])), (() => (l2(n4), null))) : (this._clients[o3] = new E(r5, s5, this._ongoingJobsQueue, this._ongoingLowPriorityJobsQueue), this._clientPromises[o3] = Promise.resolve(this._clients[o3]), l2(i3));
      }
    }));
  }
  broadcast(e5, t3, s5) {
    ...
    for (let o3 = 0; o3 < this._clientPromises.length; ++o3) {
      ...
      i3[o3] = n4.then(((i4) => i4?.invoke(e5, t3, s5)));
    }
    return i3;
  }
  close() {
    ...
    for (const t3 of this._clientPromises) t3.then(((e6) => e6?.close()));
    this._clients.length = 0, this._clientPromises.length = 0, this._inUseClients.length = 0, i2(this);
  }
  invoke(e5, t3, s5) {
    return this.apply(e5, [t3], s5);
  }
  apply(e5, t3, s5) {
    const o3 = L();
    ("low" === s5?.priority ? this._ongoingLowPriorityJobsQueue : this._ongoingJobsQueue).push({ methodName: e5, data: t3, invokeOptions: s5, resolver: o3 });
  ...
  on(t3, s5) {
    return Promise.all(this._clientPromises).then((() => t(this._clients.map(((e5) => e5.on(t3, s5))))));
  }
  openPorts() {
    return new Promise(((e5) => {
      ...
      for (let i3 = 0; i3 < this._clientPromises.length; ++i3) {
        this._clientPromises[i3].then(((o3) => {
          o3 && (t3[i3] = o3.openPort()), 0 === --s5 && e5(t3);
        }));
      }
    }));
  }
...
//# sourceMappingURL=chunk-UINE4WEI.js.map
