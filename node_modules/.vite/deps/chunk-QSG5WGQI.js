...
var i2 = () => i.getLogger("esri.core.accessorSupport.extensions.serializableProperty.reader");
function p(t2, r3, n5) {
...
function y(t2) {
  return t2.prototype.read ? (e6, r3, n5) => {
    ...
    const o6 = typeof e6;
    if ("object" !== o6) return void i2().error(`Expected JSON value of type 'object' to deserialize type '${t2.prototype.declaredClass}', but got '${o6}'`);
    const p5 = new t2();
...
function g(t2) {
  ...
  return (p5, u5, s6) => {
    ...
    const y4 = typeof p5;
    if ("object" !== y4) return void i2().error(`Expected JSON value of type 'object' to deserialize, but got '${y4}'`);
    e6 || (e6 = v(t2));
    const f5 = t2.key;
    ...
    if (!a8) {
      ...
      return s6?.messages && p5 && s6.messages.push(new s2(`${n5}:unsupported`, t3, { definition: p5, context: s6 })), void i2().error(t3);
    }
    const d2 = new a8();
...
function i3(r3, e6) {
  ...
  r3 && (1 === t2 || "type" in r3 && e3(r3.type)) ? e6.write.writer = a5 : t2 > 1 ? e6.write.writer = l2(t2) : e6.types ? Array.isArray(e6.types) ? e6.write.writer = f2(e6.types[0]) : e6.write.writer = o4(e6.types) : e6.write.writer = s4;
}
function o4(r3) {
...
function p3(r3) {
  ...
  if (r3.json.origins) for (const e6 in r3.json.origins) {
    ...
    p(s6, o6, false), o6.types && !o6.write && r3.json.write?.enabled && (o6.write = { ...r3.json.write }), i3(s6, o6);
  }
  p(i5, r3.json, true), i3(i5, r3.json);
}
function f3(r3) {
...
var _e = class _e {
  ...
  acquire(...t2) {
    ...
    return this._acquireFunction ? this._acquireFunction(s6, ...t2) : i4(s6) && s6.acquire(...t2), s6;
  }
  release(i5) {
...
//# sourceMappingURL=chunk-QSG5WGQI.js.map
