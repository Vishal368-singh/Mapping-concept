...
var T = class {
  ...
  async _selectTilesAuto(t4, i2) {
    ...
    const s2 = t4.getTilesToFetch(), a2 = {}, r = s2.map((async (t5) => {
      const n2 = new t(null, 0, 0, 0, u()), s3 = await _2(l3.fetchAvailabilityUpsample(t5.level, t5.row, t5.col, n2, { signal: i2 }));
  ...
  static fromGeometry(e2) {
    ...
    if (t4.geometry = e2, t4.spatialReference = e2.spatialReference, e2 instanceof _v) t4.coordinates = e2.coordinates.map(((e3) => e3.clone())), t4._exporter = (t5, i2) => {
      ...
      case "point": {
        ...
        t4.coordinates = n2 && o2 ? [new w2(i2.x, i2.y, i2.z, i2.m)] : n2 ? [new w2(i2.x, i2.y, i2.z)] : o2 ? [new w2(i2.x, i2.y, null, i2.m)] : [new w2(i2.x, i2.y)], t4._exporter = (t5, i3) => e2.hasM ? new _(t5[0].x, t5[0].y, t5[0].z, t5[0].m, i3) : new _(t5[0].x, t5[0].y, t5[0].z, i3);
        break;
      }
      case "multipoint": {
        const i2 = e2, { hasZ: n2, hasM: o2 } = i2;
...
//# sourceMappingURL=ElevationQuery-KOCELNIR.js.map
