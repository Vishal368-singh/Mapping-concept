...
import {
  T
} from "./chunk-LHL64X3T.js";
import {
  o as o3
} from "./chunk-SYXIBA4E.js";
...
var l3 = class {
  ...
  async dataKey(e4, r4) {
    ...
    return s2(r4), this._getIndexedDataKey(l6, e4);
  }
...
var B = class extends p(t(f2(p2(l2(b2(j4(e2(i2(S(h2)))))))))) {
  ...
  load(e4) {
    const r4 = this.loadFromPortal({ supportedTypes: ["Vector Tile Service"], supportsData: false }, e4).catch(a3).then((async () => {
    ...
    })).catch(a3).then((() => this._loadStyle(e4)));
