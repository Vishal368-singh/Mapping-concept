...
r([m({ type: ["solid", "sketch"], readOnly: true, json: { read: true, write: { ignoreOrigin: true, isRequired: true } } })], l10.prototype, "type", void 0), r([m(c2({ colorRequiredOnWrite: true }))], l10.prototype, "color", void 0), r([m({ ...l6, json: { write: { overridePolicy: (o6) => ({ enabled: !!o6 }) } } })], l10.prototype, "extensionLength", void 0), r([m(l6)], l10.prototype, "size", void 0), l10 = r([a2("esri.symbols.edges.Edges3D")], l10);
var m9 = l10;
...
r([m(c2({ colorRequiredOnWrite: true }))], m11.prototype, "color", void 0), r([m({ ...l6, json: { write: { isRequired: true } } })], m11.prototype, "size", void 0), r([m(o4)], m11.prototype, "pattern", void 0), r([m({ type: i3, json: { default: "butt", write: { overridePolicy() {
...
r([m(c2({ colorRequiredOnWrite: true }))], m12.prototype, "color", void 0), r([m({ ...l6, json: { write: { isRequired: true } } })], m12.prototype, "size", void 0), m12 = l13 = r([a2("esri.symbols.support.Symbol3DIconOutline")], m12);
...
r([m({ type: ["style"], readOnly: true, json: { read: true, write: { ignoreOrigin: true, isRequired: true } } })], c10.prototype, "type", void 0), r([m({ type: e2, json: { default: "begin-end", write: true } })], c10.prototype, "placement", void 0), r([m({ type: n3, json: { default: "arrow", write: true } })], c10.prototype, "style", void 0), r([m({ type: l3, json: { type: [x], default: null, write: true } })], c10.prototype, "color", void 0), c10 = r([a2("esri.symbols.LineStyleMarker3D")], c10);
...
r([m({ type: m10, json: { write: true } })], d5.prototype, "material", void 0), r([r3({ Line: "line" }, { readOnly: true })], d5.prototype, "type", void 0), r([m({ type: a5, json: { write: true, default: "miter" } })], d5.prototype, "join", void 0), r([m({ type: i3, json: { write: true, default: "butt" } })], d5.prototype, "cap", void 0), r([m({ ...l6, json: { write: { isRequired: true } } })], d5.prototype, "size", void 0), r([m(o4)], d5.prototype, "pattern", void 0), r([m({ types: { key: "type", base: c10, typeMap: { style: c10 } }, json: { write: true } })], d5.prototype, "marker", void 0), d5 = j3 = r([a2("esri.symbols.LineSymbol3DLayer")], d5);
...
r([m({ type: m10, json: { write: true } })], n8.prototype, "material", void 0), r([m({ type: Boolean, nonNullable: true, json: { write: true, default: true } })], n8.prototype, "castShadows", void 0), r([r3({ Path: "path" }, { readOnly: true })], n8.prototype, "type", void 0), r([m({ type: ["circle", "quad"], json: { write: true, default: "circle" } })], n8.prototype, "profile", void 0), r([m({ type: a5, json: { write: true, default: "miter" } })], n8.prototype, "join", void 0), r([m({ type: u3, json: { write: true, default: "butt" } })], n8.prototype, "cap", void 0), r([m({ type: Number, json: { write: { enabled: true, target: { width: { type: Number }, size: { type: Number } } } } })], n8.prototype, "width", void 0), r([o("width", ["width", "size", "height"])], n8.prototype, "readWidth", null), r([m({ type: Number, json: { write: true } })], n8.prototype, "height", void 0), r([o("height", ["height", "size", "width"])], n8.prototype, "readHeight", null), r([m({ type: ["center", "bottom", "top"], json: { write: true, default: "center" } })], n8.prototype, "anchor", void 0), r([m({ type: ["heading", "all"], json: { write: true, default: "all" } })], n8.prototype, "profileRotation", void 0), n8 = h4 = r([a2("esri.symbols.PathSymbol3DLayer")], n8);
...
r([m(c2())], l14.prototype, "color", void 0), r([m(l6)], l14.prototype, "size", void 0), l14 = m13 = r([a2("esri.symbols.support.Symbol3DHalo")], l14);
...
r([m({ type: l4, json: { write: true } })], y2.prototype, "font", null), r([r2("font")], y2.prototype, "writeFont", null), r([m({ type: l14, json: { write: true } })], y2.prototype, "halo", void 0), r([m({ ...m4, json: { default: "center", write: true } })], y2.prototype, "horizontalAlignment", void 0), r([m({ ...n2, json: { default: 1, write: true } })], y2.prototype, "lineHeight", void 0), r([m({ type: m10, json: { write: true } })], y2.prototype, "material", void 0), r([m({ type: c11, json: { write: true } })], y2.prototype, "background", void 0), r([m(l6)], y2.prototype, "size", null), r([m({ type: String, json: { write: true } })], y2.prototype, "text", void 0), r([r3({ Text: "text" }, { readOnly: true })], y2.prototype, "type", void 0), r([m({ ...p2, json: { default: "baseline", write: true } })], y2.prototype, "verticalAlignment", void 0), y2 = g3 = r([a2("esri.symbols.TextSymbol3DLayer")], y2);
...
r([r3({ line: "line" })], u4.prototype, "type", void 0), r([m(c2({ colorRequiredOnWrite: true }))], u4.prototype, "color", void 0), r([m({ ...l6, json: { write: { isRequired: true } } })], u4.prototype, "size", void 0), r([m({ type: m15, json: { write: true } })], u4.prototype, "border", void 0), r([m({ readOnly: true })], u4.prototype, "visible", null), u4 = a10 = r([a2("esri.symbols.callouts.LineCallout3D")], u4);
...
r([m({ ...l6, json: { write: { isRequired: true } } })], i8.prototype, "screenLength", void 0), r([m({ type: Number, nonNullable: true, json: { write: true, default: 0 } })], i8.prototype, "minWorldLength", void 0), r([m({ type: Number, json: { write: true } })], i8.prototype, "maxWorldLength", void 0), i8 = n9 = r([a2("esri.symbols.support.Symbol3DVerticalOffset")], i8);
...
var u9 = h6 = class extends c {
  ...
  async _fetchSymbol(t10) {
    ...
    const { resolveWebStyleSymbol: l19 } = await import("./webStyleSymbolUtils-FRMAJ5ZT.js");
    s4(t10);
...
//# sourceMappingURL=chunk-Z7YG4UNG.js.map
