...
async function o2(o3) {
  const a2 = "portalItem" in o3 ? o3 : { portalItem: o3 }, { fromItem: e } = await import("./portalLayers-RLNWIP6R.js");
  try {
    return await e(a2);
  } catch (p2) {
...
var h = class extends o.EventedMixin(n.IdentifiableMixin(p)) {
  ...
  static async fromArcGISServerUrl(e) {
    ...
    return (await import("./arcgisLayers-NWT7NA22.js")).fromUrl(t);
  }
...
//# sourceMappingURL=chunk-ISLYMPIF.js.map
