...
async function H(e) {
  ...
  e.forEach((({ type: e2 }) => {
    switch (l2(e2)) {
      case "CatalogLayer":
        r.push(import("./CatalogLayer-E2SE25GT.js").then(((e3) => e3.default)));
        break;
      case "FeatureLayer":
        r.push(import("./FeatureLayer-MXUCWYAK.js").then(((e3) => e3.default)));
        break;
      case "OrientedImageryLayer":
        r.push(import("./OrientedImageryLayer-RVGROIOM.js").then(((e3) => e3.default)));
    }
  }));
...
//# sourceMappingURL=featureLayerUtils-N2TLO4UZ.js.map
