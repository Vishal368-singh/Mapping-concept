...
var _Panel = class _Panel extends LitElement {
  ...
  render() {
    ...
    const panelNode = html`<article .ariaBusy=${loading} class=${safeClassMap(CSS.container)} .hidden=${isClosed} ${ref(this.setContainerRef)}>${this.renderHeaderNode()}${this.renderContent()}${this.renderContentBottom()}${this.renderFooterNode()}${keyed("alerts", html`<slot name=${SLOTS2.alerts} @slotchange=${this.handleAlertsSlotChange}></slot>`)}</article>`;
...
@esri/calcite-components/dist/components/calcite-panel/customElement.js:
  ...
  v3.2.1 *)
*/
//# sourceMappingURL=chunk-ITEIXZCR.js.map
