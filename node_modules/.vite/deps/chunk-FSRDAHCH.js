import {
  e
} from "./chunk-RO6HF3TX.js";
import {
  O
} from "./chunk-73WNLC5A.js";
import {
  l as l6
...
var L = I = (_a = class extends l.JSONSupportMixin(p2) {
  ...
  set layers(r5) {
    this._set("layers", n(r5, this._get("layers")));
  }
  ...
  async queryElevation(r5, e2) {
    ...
    const { ElevationQuery: o4 } = await import("./ElevationQuery-KOCELNIR.js");
    s2(e2);
  ...
  async _loadLayersFromJSON(r5, e2, o4) {
    const t4 = e2?.origin || "web-scene", s4 = e2?.portal || null, a6 = e2?.url || null, { populateOperationalLayers: i5 } = await import("./layersCreator-QP455K5C.js");
    s2(o4);
    const n5 = [];
...
var u2 = class extends l.JSONSupportMixin(a4) {
  constructor(e2) {
    super(e2), this.id = `focusarea-${n2()}`, this.title = null, this.enabled = true, this.outline = null, this.geometries = new l6();
  }
...
//# sourceMappingURL=chunk-FSRDAHCH.js.map
