...
async function f5(e5, t5, n5) {
  const { source: o4 } = t5, { loadGLTFMesh: i6 } = await h(import("./loadGLTFMesh-JLCARV7A.js"), n5), l4 = await p4(o4, n5);
  s2(n5);
...
var q2 = H2 = class extends p.LoadableMixin(m3.EsriPromiseMixin(c2)) {
  ...
  async toBinaryGLTF(e5) {
    const [{ toBinaryGLTF: t5 }] = await Promise.all([import("./gltfexport-DWIJLXCY.js"), this.load(e5)]);
  ...
  static async createFromGLTF(e5, t5, r5) {
    ...
    const { loadGLTFMesh: s4 } = await h(import("./loadGLTFMesh-JLCARV7A.js"), r5);
...
r([m({ type: [h3], json: { write: true } })], q2.prototype, "components", void 0), r([m({ nonNullable: true, types: K2, constructOnly: true, json: { write: true } })], q2.prototype, "vertexSpace", void 0), r([m({ type: A2, json: { write: true } })], q2.prototype, "transform", void 0), r([m({ constructOnly: true })], q2.prototype, "metadata", void 0), r([m()], q2.prototype, "hasExtent", null), r([m()], q2.prototype, "_transformedExtent", null), r([m()], q2.prototype, "_untransformedBounds", null), r([m()], q2.prototype, "origin", null), r([m({ readOnly: true, json: { read: false } })], q2.prototype, "extent", null), r([m({ readOnly: true, json: { read: false, write: true, default: true } })], q2.prototype, "hasZ", void 0), r([m({ readOnly: true, json: { read: false, write: true, default: false } })], q2.prototype, "hasM", void 0), r([m({ type: p3, nonNullable: true, json: { write: true } })], q2.prototype, "vertexAttributes", void 0), q2 = H2 = r([a("esri.geometry.Mesh")], q2);
var J2 = j();

export {
  q2 as q
};
//# sourceMappingURL=chunk-27HNBXL6.js.map
