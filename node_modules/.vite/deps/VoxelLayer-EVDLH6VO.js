...
var m3 = class extends a5.ClonableMixin(l) {
  ...
  get orientation() {
    ...
    return a7.normalize(a2(o3), 0, true);
  }
  set orientation(o3) {
  ...
  get tilt() {
    if (!Array.isArray(this.normal) || 3 !== this.normal.length) return 0;
    const [o3, r5] = b3(this.normal);
    return a7.normalize(a2(r5), 0, true);
  }
  set tilt(o3) {
...
r([m({ type: Boolean, json: { write: true } })], m3.prototype, "enabled", void 0), r([m({ type: String, json: { write: true } })], m3.prototype, "label", void 0), r([m({ type: Number, json: { read: false }, clonable: false, range: { min: 0, max: 360 } }), s2(((o3) => a7.normalize(a2(o3), 0, true)))], m3.prototype, "orientation", null), r([m({ type: Number, json: { read: false }, clonable: false, range: { min: 0, max: 360 } }), s2(((o3) => a7.normalize(a2(o3), 0, true)))], m3.prototype, "tilt", null), r([m({ type: [Number], json: { write: { isRequired: true } } })], m3.prototype, "normal", void 0), r([m({ type: [Number], json: { write: { isRequired: true } } })], m3.prototype, "point", void 0), m3 = r([a3("esri.layers.voxel.VoxelSlice")], m3);
...
var d2 = class extends a5.ClonableMixin(l) {
  ...
  get orientation() {
    ...
    return a7.normalize(a2(e4), 0, true);
  }
  get tilt() {
    if (!Array.isArray(this.normal) || 3 !== this.normal.length) return 0;
    const [e4, r5] = b3(this.normal);
...
var m4 = class extends a5.ClonableMixin(l) {
  ...
  get tilt() {
    if (!Array.isArray(this.normal) || 3 !== this.normal.length) return 0;
    const [o3, t6] = b3(this.normal);
    return a7.normalize(a2(t6), 0, true);
  }
  set tilt(o3) {
...
r([m({ type: Boolean, json: { default: true, write: true } })], m4.prototype, "enabled", void 0), r([m({ type: String, json: { write: true } })], m4.prototype, "label", void 0), r([m({ type: Number, json: { read: false }, clonable: false, range: { min: 0, max: 360 } }), s2(((o3) => a7.normalize(a2(o3), 0, true)))], m4.prototype, "orientation", null), r([m({ type: Number, json: { read: false }, clonable: false, range: { min: 0, max: 360 } }), s2(((o3) => a7.normalize(a2(o3), 0, true)))], m4.prototype, "tilt", null), r([m({ type: [Number], json: { write: { isRequired: true } } })], m4.prototype, "normal", void 0), r([m({ type: [Number], json: { write: { isRequired: true } } })], m4.prototype, "point", void 0), m4 = r([a3("esri.layers.voxel.VoxelDynamicSection")], m4);
...
//# sourceMappingURL=VoxelLayer-EVDLH6VO.js.map
