import "./chunk-R6HO3WLY.js";
import "./chunk-QYDHMHNZ.js";
import "./chunk-K4WZ5O6Y.js";
import "./chunk-7E66HRND.js";
...
function e2() {
  return n5 || (n5 = new Promise(((t) => import("./i3s-PEEYAXIF.js").then(((t2) => t2.i)).then((({ default: e4 }) => {
...
async function h2(e4) {
  ...
  let l;
  const [{ projectBuffer: u3 }, { initializeProjection: m2 }] = await Promise.all([import("./projectBuffer-ZUBKHR4W.js"), import("./projectionUtils-SRNT3PO4.js")]);
  await m2(f2, c3);
  const y2 = [0, 0, 0];
  ...
  if ("georeferenced" === a2.type && null == a2.origin) {
    ...
    const e5 = "georeferenced" === a2.type ? i.fromJSON(a2) : i2.fromJSON(a2), { projectMeshVertexPositions: r4 } = await import("./projectMeshVertexPositions-XKWVHMBG.js"), s2 = r4({ vertexAttributes: { position: i5 }, transform: n8 ? { localMatrix: n8 } : void 0, vertexSpace: e5, spatialReference: f2 }, c3);
...
//# sourceMappingURL=SceneLayerWorker-EBBZKTLQ.js.map
