...
async function M(e3, r2) {
  ...
  return await t2.load(), null === N && (N = await import("./knowledgeGraphService-OCSOTII7.js")), await N.fetchKnowledgeGraph(t2.url);
}
...
function V(e3) {
  "async" === e3.mode && (e3.functions.knowledgegraphbyportalitem = function(t2, s3) {
    ...
    return e3.standardFunctionAsync(r2, i2, (async (e4, c3, f2) => {
      ...
      null === N && (N = await import("./knowledgeGraphService-OCSOTII7.js"));
      let d = null;
      const h = q(f2[2], null);
...
//# sourceMappingURL=knowledgegraph-Z7XBRYTN.js.map
