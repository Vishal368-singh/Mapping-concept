...
var K = class extends S(a5.ClonableMixin(n.IdentifiableMixin(p))) {
  ...
  get _titleCreator() {
    ...
    return u3(e3), new u6({ fieldsIndex: this.fieldsIndex, objectIdField: this.objectIdField, displayField: this.parent?.displayField ?? "", fields: this.fields, effectivePopupTemplate: this.popupTemplate ?? this.defaultPopupTemplate });
  }
  get capabilities() {
...
var ye = class extends k2(a6(F(p2(c2(t2(f2(l2(b(j2(S(e2(i2(a5.ClonableMixin(h2)))))))))))))) {
  constructor(...e3) {
    super(...e3), this._sublayerLookup = /* @__PURE__ */ new Map(), this.fields = null, this.fieldsIndex = null, this.outFields = null, this.sublayers = new (V.ofType(K))(), this.useUniqueColorsForSublayers = true, this.supportedSourceTypes = /* @__PURE__ */ new Set(["Feature Layer", "Table"]), this.timeInfo = null, this.title = "Layer", this.type = "subtype-group", this._debouncedSaveOperations = k((async (e4, t4, r4) => {
      const { save: s3, saveAs: i4 } = await import("./featureLayerUtils-N2TLO4UZ.js");
      switch (e4) {
        case A3.SAVE:
          return s3(this, t4);
        case A3.SAVE_AS:
  ...
  async createGraphicsSource(e3) {
    const { default: t4 } = await h(import("./FeatureLayerSource-BEFO35FT.js"), e3);
...
r([m({ readOnly: true })], ye.prototype, "createQueryVersion", null), r([m({ readOnly: true })], ye.prototype, "editingEnabled", null), r([m({ readOnly: true })], ye.prototype, "effectiveEditingEnabled", null), r([m({ ...le.fields, readOnly: true, json: { origins: { service: { read: true } }, read: false } })], ye.prototype, "fields", void 0), r([m(le.fieldsIndex)], ye.prototype, "fieldsIndex", void 0), r([m(u7)], ye.prototype, "id", void 0), r([m({ type: ["show", "hide", "hide-children"], json: { origins: { "portal-item": { read: false, write: false } } } })], ye.prototype, "listMode", void 0), r([m({ type: ["SubtypeGroupLayer", "SubtypeGroupTable"], json: { ...pe(), origins: { "web-document": pe(), "portal-item": pe() } } })], ye.prototype, "operationalLayerType", null), r([m(le.outFields)], ye.prototype, "outFields", void 0), r([m({ readOnly: true })], ye.prototype, "parsedUrl", null), r([m({ clonable: false })], ye.prototype, "source", null), r([m({ type: V.ofType(K), json: { origins: { service: { read: { source: "subtypes", reader(e3, t4, s3) {
  ...
  return new (V.ofType(K))(o2);
} } } }, read: { source: ["layers", "tables"], reader(e3, t4, s3) {
  let i4;
  return "SubtypeGroupLayer" === t4.layerType && t4.layers?.length ? i4 = ue(t4.layers, s3) : "SubtypeGroupTable" === t4.layerType && t4.tables?.length && (i4 = ue(t4.tables, s3)), new (V.ofType(K))(i4);
...
} } } })], ye.prototype, "sublayers", void 0), r([m()], ye.prototype, "useUniqueColorsForSublayers", void 0), r([m({ type: u5 })], ye.prototype, "timeInfo", void 0), r([m({ json: { origins: { "portal-item": { write: { enabled: true, ignoreOrigin: true, writerEnsuresNonNull: true } } } } })], ye.prototype, "title", void 0), r([o("service", "title", ["name"])], ye.prototype, "readTitleFromService", null), r([m({ json: { read: false } })], ye.prototype, "type", void 0), r([m({ clonable: false, readOnly: true })], ye.prototype, "featureTitleFields", null), ye = r([a2("esri.layers.SubtypeGroupLayer")], ye);
var de = ye;
export {
  de as default
};
//# sourceMappingURL=SubtypeGroupLayer-VXQCY7F2.js.map
