...
import {
  ...
  m as m2,
  t2 as t4
} from "./chunk-UPZIOFJ3.js";
import {
  i as i4
} from "./chunk-X5LWS6YH.js";
import {
  i as i3
...
async function i6({ fieldName: i7, statisticsInfo: a9, errorContext: o2, fieldsIndex: r4, path: n4, customParameters: l6, apiKey: c3, signal: f3 }) {
  ...
  const m6 = V2(n4, h4.href), { data: u6 } = await H(m6, { query: { f: "json", ...l6, token: c3 }, responseType: "json", signal: f3 });
  return u6;
}
...
async function t6(e5) {
  const { BlobReader: t7, ZipReader: r4, BlobWriter: n4 } = await import("./zipjs-wrapper-H4ABTWV6.js"), a9 = [], i7 = new r4(new t7(e5));
...
var Ae = class extends m5(F(R2(l2(b2(j2(t(S(e2(i3(a5.ClonableMixin(h2))))))))))) {
  ...
  async applyEdits(e5, t7) {
    const { applyEdits: r4 } = await import("./editingSupport-MQQR6TSZ.js");
    let i7 = t7;
    await this.load();
  ...
  async convertMesh(e5, t7) {
    ...
    const a9 = this.spatialReference, l6 = t7.location ?? new _({ x: 0, y: 0, z: 0, spatialReference: a9 }), p6 = l6.spatialReference.isGeographic ? "local" : "georeferenced", { default: d3 } = await import("./Mesh-VENC6JOP.js"), y2 = d3.createWithExternalSource(l6, { type: "client", files: i7 }, { vertexSpace: p6, transform: t4(l6.spatialReference), unitConversionDisabled: true }), [u6] = await this.uploadAssets([y2], { ...t7, useAssetOrigin: !t7.location });
    return u6;
  }
  ...
  async _setAssociatedFeatureLayer(e5) {
    if (["mesh-pyramids", "points"].includes(this.profile)) try {
      const { serverUrl: t7, layerId: r4, portalItem: i7 } = await s4(`${this.url}/layers/${this.layerId}`, { sceneLayerItem: this.portalItem, customParameters: this.customParameters, apiKey: this.apiKey, signal: e5 }), s6 = await a8.FeatureLayer();
...
//# sourceMappingURL=SceneLayer-X2XHKFQ2.js.map
