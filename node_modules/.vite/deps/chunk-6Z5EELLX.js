...
r([m2()], p4.prototype, "format", void 0), r([m2({ json: { name: "itemID", write: true } })], p4.prototype, "itemId", void 0), r([m2()], p4.prototype, "type", void 0), r([o2("type")], p4.prototype, "readType", null), r([m2({ json: { write: true } })], p4.prototype, "url", void 0), p4 = r([a("esri.rest.support.RasterData")], p4);
  ...
  switch (e16) {
    ...
    case "feature-record-set-layer":
      ...
      if ("layerDefinition" in t21) {
        const e17 = new (0, (await import("./FeatureLayer-MXUCWYAK.js")).default)(), { layerDefinition: a9, featureSet: n7 } = t21;
...
var g3 = (_a = class extends l {
  ...
  async fetchResultMapImageLayer() {
    ...
    return new (0, (await import("./MapImageLayer-QRD4DSLW.js")).default)({ url: t21 });
  }
...
async function o4(s10) {
  if (s10) {
    const { default: s11 } = await import("./arcgis-knowledge-client-core-simd-ED4Q3WOK.js").then(((e16) => e16.a));
    return s11({ locateFile: (s12) => n(t7 + s12) });
  }
  const { default: n7 } = await import("./arcgis-knowledge-client-core-7BN5RJIG.js").then(((e16) => e16.a));
...
function u3(t21, i12) {
  if (t21 instanceof m5) return g4(t21, i12);
...
//# sourceMappingURL=chunk-6Z5EELLX.js.map
