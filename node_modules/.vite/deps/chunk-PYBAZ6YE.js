...
function f(r2, o3, u6, l2, a6, p2) {
  ...
  if ((null === f3 && !a6.allowNull && !a6.writerEnsuresNonNull || void 0 === f3) && a6.isRequired) {
    const i3 = new s2("web-document-write:property-required", `Missing value for required property '${u6}' on '${r2.declaredClass}'`, { propertyName: u6, target: r2 });
...
function s5(e3, r2, o3) {
  ...
  if ("string" == typeof n4) {
    ...
    if (n4.includes(".") && 0 === n4.indexOf(r2) && s(n4, o3)) return true;
  } else for (const s6 of n4) {
    if (s6 === r2) return true;
    if (s6.includes(".") && 0 === s6.indexOf(r2) && s(s6, o3)) return true;
  }
  return false;
}
function i2(e3) {
...
//# sourceMappingURL=chunk-PYBAZ6YE.js.map
