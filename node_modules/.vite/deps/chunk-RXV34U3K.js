...
var a5 = class {
  constructor() {
    this._dispatcher = new n2(), this._workerPostMessage({ type: e3.HANDSHAKE });
  }
  terminate() {
  }
  get onmessage() {
  ...
  addEventListener(e4, s6, r3) {
    this._dispatcher.addEventListener(e4, s6, r3);
  }
  removeEventListener(e4, s6, r3) {
    this._dispatcher.removeEventListener(e4, s6, r3);
  }
...
async function k() {
  ...
  if (g) try {
    ...
    d().warn(h, y), e4 = new a5();
  }
  else d().warn(h, y), e4 = new a5();
  return w2(e4);
}
async function w2(e4) {
  return new Promise(((r3) => {
    function t2(s6) {
      const a7 = f(s6);
      a7 && a7.type === m && (e4.removeEventListener("message", t2), e4.removeEventListener("error", o), r3(e4));
    }
    function o(r4) {
      r4.preventDefault(), e4.removeEventListener("message", t2), e4.removeEventListener("error", o), d().warn("Failed to create Worker. Fallback to execute module in main thread", r4), (e4 = new a5()).addEventListener("message", t2), e4.addEventListener("error", o);
    }
...
function b2() {
  ...
  const n3 = s.workers.loaderConfig, i4 = r2({ baseUrl: n3?.baseUrl, locale: i2(), has: { "csp-restrictions": 1, "dojo-test-sniff": 0, "host-webworker": 1, ...n3?.has }, map: { ...n3?.map }, paths: { ...n3?.paths }, packages: n3?.packages || [] }), l3 = { buildDate: a, fullVersion: r, revision: e };
...
var j = class _j {
  ...
  constructor(e4, o) {
    this._outJobs = /* @__PURE__ */ new Map(), this._inJobs = /* @__PURE__ */ new Map(), this.worker = e4, this.id = o, e4.addEventListener("message", this._onMessage.bind(this)), e4.addEventListener("error", ((e5) => {
      e5.preventDefault(), i.getLogger("esri.core.workers.WorkerOwner").error(e5);
    }));
  }
  terminate() {
  ...
  async open(e4, t2 = {}) {
    ...
    return new Promise(((t3, n3) => {
      ...
      this._outJobs.set(r3, a7), this._post({ type: _2, jobId: r3, modulePath: e4 });
    }));
  }
  _onMessage(e4) {
    const t2 = f(e4);
  ...
  _onInvokeMessage(e4) {
    const { methodName: t2, jobId: o, data: s6, abortable: i4 } = e4, l3 = i4 ? new AbortController() : null, d3 = this._inJobs, h3 = a3[t2];
    let p3;
    try {
    ...
    S(p3) ? (d3.set(o, { controller: l3, promise: p3 }), p3.then(((e5) => {
      d3.has(o) && (d3.delete(o), this._post({ type: u, jobId: o }, e5));
    }), ((e5) => {
      d3.has(o) && (d3.delete(o), e5 || (e5 = { message: "Error encountered at method" + t2 }), b(e5) || this._post({ type: u, jobId: o, error: i3(e5 || { message: `Error encountered at method ${t2}` }) }));
    }))) : this._post({ type: u, jobId: o }, p3);
  }
  _onOpenedMessage(e4) {
    const { jobId: t2, data: s6 } = e4, r3 = this._outJobs.get(t2);
...
async function f2(r3, t2) {
  ...
  return await n3.open(r3, s6), i4 && e2(i4, n3), n3;
}
async function p2(e4, o = {}) {
  ...
  if (has("host-webworker") && !has("esri-workers") && (i4 = "local"), "local" === i4) {
    ...
    return f2([E.connect(r3, o.schedule)], { ...o, client: i5 });
  }
  if (await g3(), s3(o.signal), "dedicated" === i4) {
    const r3 = c2++ % a6;
    return f2([await l2[r3].open(e4, o)], o);
  }
  if (o.maxNumWorkers && o.maxNumWorkers > 0) {
    ...
    if (r3 < a6) {
      ...
      for (let n3 = 0; n3 < r3; ++n3) {
        const r4 = c2++ % a6;
        t2[n3] = l2[r4].open(e4, o);
      }
      return f2(t2, o);
    }
  }
  return f2(l2.map(((r3) => r3.open(e4, o))), o);
}
var h2;
var d2 = null;
async function g3() {
  ...
  for (let t2 = 0; t2 < a6; t2++) {
    const e4 = j.create(t2).then(((r4) => (l2[t2] = r4, r4)));
    r3.push(e4);
  }
...
//# sourceMappingURL=chunk-RXV34U3K.js.map
