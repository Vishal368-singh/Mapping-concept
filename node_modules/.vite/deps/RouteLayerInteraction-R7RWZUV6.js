...
import {
  ...
  p as p4,
  s as s5
} from "./chunk-L7FJP36K.js";
import "./chunk-W5CL56LA.js";
import {
  r as r6
} from "./chunk-32GGXKR7.js";
import {
  r as r7
} from "./chunk-YH7GPSW7.js";
...
import {
  ...
  t,
  z
} from "./chunk-WMDBZZHG.js";
import {
  c as c6,
  l as l6,
  l2 as l7,
  r as r3
} from "./chunk-R654V4KW.js";
import {
  p as p3
} from "./chunk-LDUBOOQD.js";
import "./chunk-JJUWIC23.js";
...
var x3 = class extends o.EventedMixin(b) {
  ...
  async _createSelfSnappingEngine(e6) {
    const [{ SelfSnappingEngine: t3 }, n10] = await Promise.all([import("./SelfSnappingEngine-D4W73KCM.js"), g4()]);
  ...
  async _createGridSnappingEngine(e6) {
    ...
    const { GridSnappingEngine: n10 } = await import("./GridSnappingEngine-FEL7SAWY.js");
    return s2(e6), { type: "grid", engine: new n10({ view: t3, options: this.options }) };
  }
  async _createFeatureSnappingEngine(e6) {
    const { FeatureSnappingEngine: t3 } = await import("./FeatureSnappingEngine-HAERW52R.js");
    s2(e6);
...
async function o4() {
  const e6 = await import("./@arcgis_core_geometry_geometryEngine.js");
  return s6(e6);
}
function n6(t3) {
...
var re = class extends o.EventedAccessor {
  ...
  initialize() {
    this.addHandles([a2((() => this.view?.map?.layers), "change", ((e6) => {
      ...
      this._defaultSnappingManager = u(this._defaultSnappingManager), e6 && (this.snappingManager || (this._defaultSnappingManager = new x3({ view: e6, options: this.snappingOptions })), "2d" === e6.type ? import("./editingTools-KYRXDXTV.js") : "3d" === e6.type && (import("./editingTools-5J24QB7J.js"), import("./GraphicsLayerView3D-TBSV45AW.js")));
  ...
  async _makeDrawGraphicTool2D(e6) {
    const [t3, o6, i4] = await Promise.all([this._requireModule(import("./editingTools-KYRXDXTV.js")), u5(), c8()]);
  ...
  async _makeDrawGraphicTool3D(e6) {
    const [t3, o6, i4] = await Promise.all([this._requireModule(import("./editingTools-5J24QB7J.js")), u5(), c8()]);
  ...
  async _setupMove3DOperation(e6, t3, o6, i4, s8 = false) {
    const [r12, n10] = await Promise.all([this._requireModule(import("./editingTools-5J24QB7J.js")), c8()]);
  ...
  async _setupPointTransform3DOperation(e6, t3, o6) {
    const i4 = "transform", { enableRotation: s8, enableScaling: r12, enableZ: n10 } = t3, p8 = await this._requireModule(import("./editingTools-5J24QB7J.js"));
    if (ge(p8)) return p8;
  ...
  async _setupPolyTransform3DOperation(e6, t3, o6, i4 = false) {
    const s8 = "transform", { enableRotation: r12, enableScaling: n10, enableZ: p8, preserveAspectRatio: l9 } = t3, [h8, c9] = await Promise.all([this._requireModule(import("./editingTools-5J24QB7J.js")), c8()]);
    if (ge(h8)) return h8;
  ...
  async _setupReshape3DOperation(e6, t3, o6, i4 = false) {
    const s8 = "reshape", [r12, n10, p8] = await Promise.all([this._requireModule(import("./editingTools-5J24QB7J.js")), u5(), c8()]);
    if (ge(r12)) return r12;
  ...
  async _getGraphicMover(e6, t3, o6) {
    const { enableMoveAllGraphics: i4, highlightOptions: a8 } = t3, s8 = await this._requireModule(import("./GraphicMover-YATALG3R.js"));
  ...
  async _getBox(e6, t3, o6) {
    const { enableRotation: i4, enableScaling: a8, highlightOptions: s8, preserveAspectRatio: r12 } = t3, [n10, p8] = await Promise.all([this._requireModule(import("./Box-SC7YJOI4.js")), c8()]);
  ...
  async _getReshape(e6, t3, o6) {
    const { highlightOptions: i4, reshapeOptions: a8 } = t3, s8 = "split" === a8?.edgeOperation, r12 = "move" === a8?.shapeOperation, [n10, p8, l9] = await Promise.all([this._requireModule(import("./Reshape-XV3KDRBG.js")), u5(), c8()]);
...
//# sourceMappingURL=RouteLayerInteraction-R7RWZUV6.js.map
