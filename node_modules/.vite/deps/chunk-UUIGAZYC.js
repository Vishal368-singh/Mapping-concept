...
async function u() {
  if (!s2()) {
    const [e, t] = await Promise.all([import("./OperatorGeodesicBuffer-RFL2SKEO.js"), import("./ProjectionTransformation-QMVDRBGR.js").then(((e2) => e2.aG)).then((({ injectPe: e2 }) => e2)), _()]);
...
//# sourceMappingURL=chunk-UUIGAZYC.js.map
