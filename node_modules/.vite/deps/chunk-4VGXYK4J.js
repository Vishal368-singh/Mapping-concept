import {
  T
} from "./chunk-RIB5GFVA.js";
import {
  s as s7,
  v as v2
} from "./chunk-ROF2AMCT.js";
import {
  t as t2
} from "./chunk-YLMHRZGV.js";
import {
  w2 as w
} from "./chunk-PWMG7PVD.js";
import {
  x
} from "./chunk-H7MZD3K2.js";
import {
  Xe
} from "./chunk-Z5JR5AC4.js";
import {
  s as s6
} from "./chunk-RD7BZJOG.js";
import {
  d as d5
} from "./chunk-DH2XXT4G.js";
import {
  A as A2,
  D,
  E,
...
import {
  c as c6
} from "./chunk-FUTUNQRP.js";
import {
  p as p3
} from "./chunk-BNRCBLJQ.js";
import {
  c as c5
...
var y3 = class extends b2 {
  ...
  async getAttachments() {
    const { _attachmentLayer: t5, attachmentInfos: e14, orderByFields: i11 } = this;
    ...
    const r7 = i11?.map(((t6) => `${t6.field} ${"descending" === t6.order ? "DESC" : "ASC"}`)), s12 = new p3({ objectIds: [a7], returnMetadata: true, orderByFields: r7 }), o5 = [], c14 = t5.queryAttachments(s12).then(((t6) => t6[a7] || o5)).catch((() => o5));
  ...
  async addAttachment(t5, e14 = this.graphic) {
    ...
    const s12 = i11.addAttachment(e14, t5).then(((t6) => this._queryAttachment(t6.objectId, e14))), o5 = await s12;
    return a7.add(o5), o5;
  }
  async deleteAttachment(t5) {
    ...
    const s12 = e14.deleteAttachments(a7, [t5.id]).then((() => t5)), o5 = await s12;
  ...
  async updateAttachment(t5, e14 = this.activeAttachmentInfo) {
    ...
    const c14 = i11.updateAttachment(r7, e14.id, t5).then(((t6) => this._queryAttachment(t6.objectId))), h8 = await c14;
  ...
  addFile(t5, e14) {
    ...
    const i11 = { file: t5, form: e14 };
    return this.fileInfos.add(i11), i11;
  }
  updateFile(t5, e14, i11 = this.activeFileInfo) {
    if (!t5 || !e14 || !i11) return null;
  ...
  async _queryAttachment(t5, e14) {
    ...
    if (!t5 || !i11?.queryAttachments) throw new s("invalid-attachment-id", "Could not query attachment.");
    const a7 = this._getObjectId(e14);
    if ("number" != typeof a7) throw new s("invalid-object-id", "getAttachments(): Numeric object id is required");
    const r7 = new p3({ objectIds: [a7], attachmentsWhere: `AttachmentId=${t5}`, returnMetadata: true });
    return i11.queryAttachments(r7).then(((t6) => t6[a7][0]));
  }
  _getObjectId(t5 = this.graphic) {
    return t5?.getObjectId() ?? null;
  }
  _graphicChanged() {
    this.graphic && (this._setAttachmentLayer(), this.getAttachments().catch((() => this.attachmentInfos.destroyAll())));
  }
  _setAttachmentLayer() {
    const { graphic: t5 } = this, e14 = L3(t5);
...
var M2 = class extends O {
  ...
  loadDependencies() {
    return c3({ icon: () => import("./calcite-icon-JQPP5WAE.js") });
  }
  get capabilities() {
  ...
  updateAttachment() {
    ...
    return this._set("submitting", true), this._set("error", null), e14.updateAttachment(s12).then(((t5) => (this._set("submitting", false), this._set("error", null), e14.mode = "view", t5))).catch(((e15) => {
  ...
  deleteFile(e14) {
    const t5 = this.viewModel.deleteFile(e14 || this.viewModel.activeFileInfo?.file);
    return this.viewModel.mode = "view", t5;
  }
  render() {
    const { submitting: e14, viewModel: t5 } = this, { state: s12 } = t5;
  ...
  _renderAttachments() {
    const { activeFileInfo: e14, mode: t5, activeAttachmentInfo: s12 } = this.viewModel;
    return "add" === t5 ? this._renderAddForm() : "edit" === t5 ? this._renderDetailsForm(s12 || e14) : this._renderAttachmentContainer();
  }
  _renderLoading() {
  ...
  _renderAddForm() {
    const { submitting: e14, selectedFile: t5 } = this, s12 = e14 || !t5, i11 = this.visibleElements.cancelAddButton ? n2("button", { bind: this, class: this.classes(e4.button, e4.buttonTertiary, e4.buttonSmall, e4.buttonHalf, e14 && e4.buttonDisabled), disabled: e14, onclick: this._cancelForm, type: "button" }, this.messages.cancel) : null, a7 = this.visibleElements.addSubmitButton ? n2("button", { class: this.classes(e4.button, e4.buttonSecondary, e4.buttonSmall, e4.buttonHalf, { [e4.buttonDisabled]: s12 }), disabled: s12, type: "submit" }, this.messages.add) : null, n13 = t5 ? n2("span", { class: F.fileName, key: "file-name" }, t5.name) : null, l5 = n2("form", { afterCreate: y2, afterRemoved: h3, bind: this, "data-node-ref": "_addAttachmentForm", onsubmit: this._submitAddAttachment }, n2("fieldset", { class: F.fileFieldset }, n13, n2("label", { class: this.classes(F.fileLabel, e4.button, e4.buttonSecondary) }, t5 ? this.messages.changeFile : this.messages.selectFile, n2("input", { bind: this, class: F.fileInput, name: "attachment", onchange: this._handleFileInputChange, type: "file" }))), a7, i11);
    return n2("div", { class: F.formNode, key: "add-form-container" }, l5);
  }
  _renderDetailsForm(e14) {
    const { visibleElements: t5, viewModel: s12, selectedFile: i11, submitting: a7 } = this, { capabilities: l5 } = s12, r7 = a7 || !i11;
    let o5, d10, c14, m6;
    ...
    const h8 = l5.editing && l5.operations?.delete && t5.deleteButton ? n2("button", { bind: this, class: this.classes(e4.button, e4.buttonSmall, e4.buttonTertiary, F.deleteButton, { [e4.buttonDisabled]: a7 }), disabled: a7, key: "delete-button", onclick: (t6) => this._submitDeleteAttachment(t6, e14), type: "button" }, this.messages.delete) : void 0, u10 = l5.editing && l5.operations?.update && t5.updateButton ? n2("button", { class: this.classes(e4.button, e4.buttonSmall, e4.buttonThird, { [e4.buttonDisabled]: r7 }), disabled: r7, key: "update-button", type: "submit" }, this.messages.update) : void 0, b9 = this.visibleElements.cancelUpdateButton ? n2("button", { bind: this, class: this.classes(e4.button, e4.buttonSmall, e4.buttonTertiary, e4.buttonThird, { [e4.buttonDisabled]: a7 }), disabled: a7, key: "cancel-button", onclick: this._cancelForm, type: "button" }, this.messages.cancel) : void 0, f8 = l5.editing && l5.operations?.update ? n2("fieldset", { class: F.fileFieldset, key: "file" }, n2("span", { class: F.fileName, key: "file-name" }, d10), n2("label", { class: this.classes(F.fileLabel, e4.button, e4.buttonSecondary) }, this.messages.changeFile, n2("input", { bind: this, class: F.fileInput, name: "attachment", onchange: this._handleFileInputChange, type: "file" }))) : void 0, v9 = n2("fieldset", { class: F.metadataFieldset, key: "size" }, n2("label", null, T(this.messagesUnits, c14 ?? 0))), A5 = n2("fieldset", { class: F.metadataFieldset, key: "content-type" }, n2("label", null, o5)), w7 = null != m6 ? n2("a", { class: F.itemLink, href: m6, rel: "noreferrer", target: "_blank" }, this._renderImageMask(e14, 400), n2("div", { class: F.itemLinkOverlay }, n2("span", { class: F.itemLinkOverlayIcon }, n2("calcite-icon", { icon: "launch" })))) : this._renderImageMask(e14, 400), k4 = n2("form", { afterCreate: y2, afterRemoved: h3, bind: this, "data-node-ref": "_updateAttachmentForm", onsubmit: (t6) => this._submitUpdateAttachment(t6, e14) }, n2("div", { class: F.metadata }, v9, A5), f8, n2("div", { class: F.actions }, h8, b9, u10));
  ...
  _renderGenericImageMask(e14, t5) {
    const { supportsResizeAttachments: s12 } = this.viewModel, i11 = p4(t5), a7 = { [F.itemImageResizable]: s12 };
  ...
  _renderImageMaskForAttachment(e14, t5) {
    ...
    const r7 = this._getCSSTransform(e14), o5 = r7 ? { transform: r7, "image-orientation": "none" } : {}, d10 = `${l5}${l5?.includes("?") ? "&" : "?"}w=${t5}&s=${n13}`, c14 = { [F.itemImageResizable]: s12 };
  ...
  _renderFile(e14) {
    const { file: t5 } = e14;
    return n2("li", { class: F.item, key: t5 }, n2("button", { "aria-label": this.messages.attachmentDetails, bind: this, class: F.itemButton, key: "details-button", onclick: () => this._startEditFile(e14), title: this.messages.attachmentDetails, type: "button" }, this._renderImageMask(e14), n2("label", { class: F.itemLabel }, n2("span", { class: F.itemFilename }, t5.name || this.messages.noTitle), n2("span", { "aria-hidden": "true", class: this.classes(F.itemChevronIcon, L2(this.container) ? i5.left : i5.right) }))));
  }
  _renderAttachmentInfo({ attachmentInfo: e14, displayType: t5 }) {
    const { viewModel: s12, effectiveDisplayType: i11 } = this, { capabilities: a7, supportsResizeAttachments: n13 } = s12, { contentType: l5, name: r7, url: o5 } = e14, d10 = this._renderImageMask(e14, "list" === t5 ? 48 : 400), c14 = a7.editing ? n2("span", { "aria-hidden": "true", class: this.classes(F.itemChevronIcon, L2(this.container) ? i5.left : i5.right) }) : null, m6 = [d10, "preview" === i11 && n13 && e5(l5) ? null : n2("label", { class: F.itemLabel }, n2("span", { class: F.itemFilename }, r7 || this.messages.noTitle), c14)], u10 = a7.editing ? n2("button", { "aria-label": this.messages.attachmentDetails, bind: this, class: F.itemButton, "data-attachment-info-id": e14.id, key: "details-button", onclick: () => this._startEditAttachment(e14), title: this.messages.attachmentDetails, type: "button" }, m6) : n2("a", { class: F.itemButton, href: o5 ?? void 0, key: "details-link", rel: "noreferrer", target: "_blank" }, m6);
    return n2("li", { class: F.item, key: e14 }, u10);
  }
  _renderAttachmentContainer() {
    const { effectiveDisplayType: e14, viewModel: t5, visibleElements: s12 } = this, { attachmentInfos: i11, capabilities: a7, fileInfos: n13 } = t5, l5 = !!i11?.length, r7 = !!n13?.length, o5 = { [F.containerList]: "preview" !== e14, [F.containerPreview]: "preview" === e14 }, d10 = a7.editing && a7.operations?.add && s12.addButton ? n2("button", { bind: this, class: this.classes(e4.button, e4.buttonTertiary, F.addAttachmentButton), onclick: () => this._startAddAttachment(), type: "button" }, n2("span", { "aria-hidden": "true", class: this.classes(F.itemAddIcon, i5.plus) }), this.messages.add) : void 0, c14 = l5 ? n2("ul", { class: F.items, key: "attachments-list" }, i11.toArray().map(((t6) => this._renderAttachmentInfo({ attachmentInfo: t6, displayType: e14 })))) : void 0, m6 = r7 ? n2("ul", { class: F.items, key: "file-list" }, n13.toArray().map(((e15) => this._renderFile(e15)))) : void 0, h8 = r7 || l5 ? void 0 : n2("div", { class: e4.empty }, this.messages.noAttachments);
  ...
  _handleFileInputChange(e14) {
    const t5 = e14.target, s12 = t5.files?.item(0);
...
var h4 = class extends O {
  constructor(e14, t5) {
    super(e14, t5), this._featureElementInfo = null, this.attachmentsWidget = new M2(), this.headingLevel = 2, this.viewModel = new s8();
  }
  initialize() {
  ...
  _setupFeatureElementInfo() {
    const { description: e14, title: t5, headingLevel: i11 } = this;
    this._featureElementInfo?.set({ description: e14, title: t5, headingLevel: i11 });
  }
};
...
var c8 = class extends b2 {
  constructor(t5) {
    super(t5), this._loadingPromise = null, this.created = null, this.creator = null, this.destroyer = null, this.graphic = null, this.addHandles(l((() => this.creator), ((t6) => {
  ...
  _destroyContent() {
    const { created: t5, graphic: e14, destroyer: r7 } = this;
    t5 && e14 && (q({ type: "content", value: r7, event: { graphic: e14 } }), this._set("created", null));
  }
  async _createContent(t5) {
    const e14 = this.graphic;
    if (!e14 || !t5) return;
    const r7 = q({ type: "content", value: t5, event: { graphic: e14 } });
...
var l3 = class extends b2 {
  ...
  get formattedFieldInfos() {
    const { expressionInfos: o5, fieldInfos: e14 } = this, t5 = [];
    return e14?.forEach(((e15) => {
      if (!(!e15.hasOwnProperty("visible") || e15.visible)) return;
      const s12 = e15.clone();
      s12.label = A2(s12, o5), t5.push(s12);
    })), t5;
  }
};
...
function r4(r7, t5) {
  if ("string" != typeof t5 || !t5) return t5;
  const n13 = p7.find(((e14) => e14.pattern.test(t5)));
  if (!n13) return t5;
  const i11 = t5.match(n13.pattern), l5 = i11?.[2], o5 = r2(r2(n13.label, { messages: r7, hierPart: l5 }), { appName: n13.appName }), m6 = n13.target ? ` target="${n13.target}"` : "", g8 = "_blank" === n13.target ? ' rel="noreferrer"' : "";
  return t.sanitizeUrl(_(t5)).replace(n13.pattern, `<a${m6} href="$1"${g8}>${o5}</a>`);
}
...
var c10 = class extends O {
  constructor(e14, t5) {
    super(e14, t5), this._featureElementInfo = null, this.viewModel = new l3(), this.messages = null, this.messagesURIUtils = null;
  }
  initialize() {
  ...
  _renderFieldInfo(e14, t5) {
    ...
    return n2("tr", { key: `fields-element-info-row-${i11}-${t5}` }, n2("th", { class: m2.fieldHeader, innerHTML: r7, key: `fields-element-info-row-header-${i11}-${t5}` }), n2("td", { class: this.classes(m2.fieldData, d10), innerHTML: n13, key: `fields-element-info-row-data-${i11}-${t5}` }));
  }
  _renderFields() {
    const { formattedFieldInfos: e14 } = this.viewModel;
    return e14?.length ? n2("table", { class: e4.table, summary: this.messages.fieldsSummary }, n2("tbody", null, e14.map(((e15, t5) => this._renderFieldInfo(e15, t5))))) : null;
  }
  _setupFeatureElementInfo() {
    const { description: e14, title: t5 } = this;
    this._featureElementInfo?.set({ description: e14, title: t5 });
  }
  _forceLTR(e14) {
    return `&lrm;${e14}`;
  }
...
function r5(r7) {
  ...
  if (e14 && e14[0]) {
    const r8 = e14[t5];
    r8 && 1 !== r8.ratio && (e14.push(new c6({ ratio: 1, color: r8.color })), t5++);
  }
  return e14.map(((o5, e15) => {
    let l5 = "";
    return 0 === e15 ? l5 = r7.legendOptions?.minLabel || "low" : e15 === t5 && (l5 = r7.legendOptions?.maxLabel || "high"), { color: o5.color, label: l5, ratio: o5.ratio };
  })).reverse();
}

// node_modules/@arcgis/core/renderers/support/utils.js
var v3 = N("short-date");
async function w3(e14, l5, t5) {
  u(e14, l5, (() => [])).push(...t5);
}
async function x3(l5) {
  ...
  if ("visualVariables" in l5 && l5.visualVariables) {
    for (const e14 of l5.visualVariables) if (D2(e14)) {
      ...
      await w3(t5, e14.field || e14.valueExpression, l6);
    }
  }
  if ("heatmap" === l5.type) {
    const e14 = r5(l5).map(((e15) => e15.color));
    await w3(t5, l5.field || l5.valueExpression, e14);
  } else if ("pie-chart" === l5.type) {
    for (const e14 of l5.attributes) await w3(t5, e14.field || e14.valueExpression, [e14.color]);
    await w3(t5, "default", [l5?.othersCategory?.color, w(l5.backgroundFillSymbol, null)]);
  } else if ("dot-density" === l5.type) {
    for (const e14 of l5.attributes) await w3(t5, e14.field || e14.valueExpression, [e14.color]);
    await w3(t5, "default", [l5.backgroundColor]);
  } else if ("unique-value" === l5.type) if ("predominance" === l5.authoringInfo?.type) for (const e14 of l5.uniqueValueInfos ?? []) await w3(t5, e14.value.toString(), [w(e14.symbol, null)]);
  else {
    const e14 = (l5.uniqueValueInfos ?? []).map(((e15) => w(e15.symbol, null))), { field: i11, field2: o5, field3: a7, valueExpression: n13 } = l5;
    (i11 || n13) && await w3(t5, i11 || n13, e14), o5 && await w3(t5, o5, e14), a7 && await w3(t5, a7, e14);
  }
  else if ("class-breaks" === l5.type) {
    const e14 = l5.classBreakInfos.map(((e15) => w(e15.symbol, null))), { field: i11, valueExpression: o5 } = l5;
    await w3(t5, i11 ?? o5, e14);
  } else "simple" === l5.type && await w3(t5, "default", [w(l5.symbol, null)]);
  return "defaultSymbol" in l5 && l5.defaultSymbol && await w3(t5, "default", [w(l5.defaultSymbol, null)]), t5.forEach(((l6, i11) => {
...
function h5(e14) {
  ...
  const [t5, r7] = e14.split("/").slice(1);
  return { layerId: t5, fieldName: r7 };
}
function y4(e14, t5) {
  if (!t5.relationships) return null;
  let r7 = null;
  const { relationships: i11 } = t5;
  return i11.some(((t6) => t6.id === parseInt(e14, 10) && (r7 = t6, true))), r7;
}
function I2({ originRelationship: e14, relationships: t5, layerId: r7 }) {
  return t5.find((({ relatedTableId: t6, id: i11 }) => `${t6}` === r7 && i11 === e14?.id)) ?? null;
}
function F2(e14, t5) {
  const r7 = t5.toLowerCase();
...
function b4(e14, t5) {
  const r7 = y4(e14, t5);
  if (!r7) return;
  return { url: `${t5.url}/${r7.relatedTableId}`, sourceSpatialReference: t5.spatialReference, relation: r7, relatedFields: [], outStatistics: [] };
}
function g(e14, t5) {
  if (!t5) return;
  if (!e14) return;
  const { features: r7, statsFeatures: i11 } = e14, o5 = r7?.value;
  t5.relatedFeatures = o5 ? o5.features : [];
  const s12 = i11?.value;
  t5.relatedStatsFeatures = s12 ? s12.features : [];
}
function S(e14, t5, r7, i11) {
  const o5 = new c5();
  return o5.outFields = ["*"], o5.relationshipId = "number" == typeof t5.id ? t5.id : parseInt(t5.id, 10), o5.objectIds = [e14.attributes[r7.objectIdField]], o5.gdbVersion = r7.gdbVersion ?? null, o5.historicMoment = r7.historicMoment ?? null, r7.queryRelatedFeatures?.(o5, i11) ?? Promise.resolve({});
}
function w4(e14, t5, r7) {
  let i11 = 0;
  const o5 = [];
  for (; i11 < t5.length; ) o5.push(`${e14} IN (${t5.slice(i11, r7 + i11)})`), i11 += r7;
  return o5.join(" OR ");
}
function j2(e14) {
...
async function $2(e14, t5, r7, i11) {
  const o5 = r7.layerId.toString(), { layerInfo: u10, relation: c14, relatedFields: f8, outStatistics: d10, url: p10, sourceSpatialReference: m6 } = t5, h8 = j2(f8), y10 = R3(d10);
  ...
  if (b9?.relationshipTableId && b9.keyFieldInRelationshipTable) {
    const t6 = (await S(e14, b9, r7, i11))[e14.attributes[r7.objectIdField]];
    if (!t6) return null;
    const o6 = t6.features.map(((e15) => e15.attributes[u10.objectIdField]));
    if (y10?.length && u10.supportsStatistics) {
      ...
      const r8 = { features: Promise.resolve(t6), statsFeatures: s6(p10, e15) };
      return y(r8);
    }
  }
  const g8 = b9?.keyField;
  if (g8) {
    const t6 = ge(L4(u10.fields, g8)), o6 = F2(e14.attributes, c14.keyField), f9 = t6 ? `${g8}=${o6}` : `${g8}='${o6}'`, d11 = r7.historicMoment, I6 = r7.gdbVersion, b10 = s6(p10, new R({ where: f9, outFields: h8, sourceSpatialReference: m6, historicMoment: d11, gdbVersion: I6 }), i11), S2 = !!y10?.length && u10.supportsStatistics ? s6(p10, new R({ where: f9, outFields: h8, outStatistics: y10, sourceSpatialReference: m6 }), i11) : null, w7 = { features: b10 };
    return S2 && (w7.statsFeatures = S2), y(w7);
  }
  return null;
}
function N3(t5, r7) {
  return H(t5, { query: { f: "json" }, signal: r7?.signal });
}
function v4({ relatedInfos: e14, layer: t5 }, i11) {
  const n13 = {};
  return e14.forEach(((e15, i12) => {
    ...
    const l5 = `${t5.url}/${s12}`, a7 = m3.get(l5), u10 = a7 ?? N3(l5);
    a7 || m3.set(l5, u10), n13[i12] = u10;
  })), h(y(n13), i11);
}
function T2({ graphic: e14, relatedInfos: t5, layer: r7 }, i11) {
  const o5 = {};
  return t5.forEach(((t6, s12) => {
    t6.layerInfo && (o5[s12] = $2(e14, t6, r7, i11));
  })), y(o5);
}
function q2({ relatedInfo: e14, fieldName: t5, fieldInfo: r7 }) {
  if (e14.relatedFields?.push(t5), r7.statisticType) {
    const i11 = new p({ statisticType: r7.statisticType, onStatisticField: t5, outStatisticFieldName: t5 });
...
function L4(e14, t5) {
  if (null != e14) {
    t5 = t5.toLowerCase();
    for (const r7 of e14) if (r7 && r7.name.toLowerCase() === t5) return r7;
  }
  return null;
}
...
var v5 = class extends b2 {
  constructor(t5) {
    super(t5), this.abilities = { ...I3 }, this.activeMediaInfoIndex = 0, this.attributes = null, this.description = null, this.fieldInfoMap = null, this.formattedAttributes = null, this.expressionAttributes = null, this.isAggregate = false, this.layer = null, this.mediaInfos = null, this.popupTemplate = null, this.relatedInfos = null, this.title = null;
  }
  castAbilities(t5) {
    return { ...I3, ...t5 };
  }
  ...
  _setContentElementMedia(t5) {
    const { formattedMediaInfoCount: e14 } = this, i11 = (t5 + e14) % e14;
    this.activeMediaInfoIndex = i11;
  }
  _pageContentElementMedia(t5) {
    const { activeMediaInfoIndex: e14 } = this, i11 = e14 + t5;
    this._setContentElementMedia(i11);
  }
  _formatMediaInfos() {
    const { mediaInfos: t5, layer: e14 } = this, o5 = this.attributes ?? {}, r7 = this.formattedAttributes ?? {}, a7 = this.expressionAttributes ?? {}, s12 = this.fieldInfoMap ?? /* @__PURE__ */ new Map();
    return t5?.map(((t6) => {
      const i11 = t6?.clone();
      if (!i11) return null;
  ...
  _setImageValue(t5) {
    const e14 = this.fieldInfoMap ?? /* @__PURE__ */ new Map(), { value: i11, formattedAttributes: o5, layer: r7 } = t5, { linkURL: a7, sourceURL: s12 } = i11;
    if (s12) {
      const t6 = Q(s12, r7);
      i11.sourceURL = z({ formattedAttributes: o5, template: t6, fieldInfoMap: e14 });
    }
    if (a7) {
      const t6 = Q(a7, r7);
      i11.linkURL = z({ formattedAttributes: o5, template: t6, fieldInfoMap: e14 });
    }
  }
  _setChartValue(t5) {
    const { value: e14, attributes: i11, formattedAttributes: o5, chartType: r7, layer: a7, expressionAttributes: s12 } = t5, { popupTemplate: l5, relatedInfos: n13 } = this, { fields: p10, normalizeField: u10 } = e14, m6 = a7;
    e14.fields = R2(p10, m6), u10 && (e14.normalizeField = M(u10, m6));
    if (!p10.some(((t6) => !!(null != o5[t6] || pe(t6) && n13?.size)))) return;
    const h8 = l5?.fieldInfos ?? [];
    p10.forEach(((t6, a8) => {
      const l6 = e14.colors?.[a8];
      if (pe(t6)) return void (e14.series = [...e14.series, ...this._getRelatedChartInfos({ fieldInfos: h8, fieldName: t6, formattedAttributes: o5, chartType: r7, value: e14, color: l6 })]);
      const n14 = this._getChartOption({ value: e14, attributes: i11, chartType: r7, formattedAttributes: o5, expressionAttributes: s12, fieldName: t6, fieldInfos: h8, color: l6 });
      e14.series.push(n14);
    }));
  }
  _getRelatedChartInfos(t5) {
    const { fieldInfos: e14, fieldName: i11, formattedAttributes: o5, chartType: r7, value: a7, color: s12 } = t5, l5 = [], n13 = h5(i11), p10 = n13 && this.relatedInfos?.get(n13.layerId.toString());
    if (!p10) return l5;
    const { relatedFeatures: u10, relation: d10 } = p10;
    if (!d10 || !u10) return l5;
    const { cardinality: f8 } = d10;
    u10.forEach(((t6) => {
      const { attributes: p11 } = t6;
      p11 && Object.keys(p11).forEach(((t7) => {
        t7 === n13.fieldName && l5.push(this._getChartOption({ value: a7, attributes: p11, formattedAttributes: o5, fieldName: i11, chartType: r7, relatedFieldName: t7, hasMultipleRelatedFeatures: u10?.length > 1, fieldInfos: e14, color: s12 }));
      }));
    }));
    return "one-to-many" === f8 || "many-to-many" === f8 ? l5 : [l5[0]];
  }
  _getTooltip({ label: t5, value: e14, chartType: i11 }) {
    return "pie-chart" === i11 ? `${t5}` : `${t5}: ${e14}`;
  }
  _getChartOption(t5) {
    const { value: e14, attributes: i11, formattedAttributes: o5, expressionAttributes: r7, fieldName: a7, relatedFieldName: n13, fieldInfos: p10, chartType: u10, hasMultipleRelatedFeatures: d10, color: I6 } = t5, v9 = this.layer, M5 = this.fieldInfoMap ?? /* @__PURE__ */ new Map(), { normalizeField: A5, tooltipField: g8 } = e14, x7 = A5 ? pe(A5) ? i11[h5(A5).fieldName] : i11[A5] : null, _5 = E(a7) && r7 && void 0 !== r7[a7] ? r7[a7] : n13 && void 0 !== i11[n13] ? i11[n13] : void 0 !== i11[a7] ? i11[a7] : o5[a7], C4 = void 0 === _5 ? null : _5 && x7 ? _5 / x7 : _5, T6 = new p2({ fieldName: a7, color: I6, value: "number" == typeof C4 ? C4 : Number(C4) });
    if (pe(a7)) {
      const t6 = M5.get(a7.toLowerCase()), e15 = g8 && M5.get(g8.toLowerCase()), r8 = t6?.fieldName ?? a7, s12 = d10 && g8 ? h5(g8).fieldName : e15?.fieldName ?? g8, l5 = d10 && s12 ? i11[s12] : o5[s12] ?? t6?.label ?? t6?.fieldName ?? n13, p11 = d10 && n13 ? i11[n13] : o5[r8];
...
var T3 = class extends O {
  constructor(e14, t5) {
    super(e14, t5), this._refreshTimer = null, this._refreshIntervalInfo = null, this._featureElementInfo = null, this._chartRootMap = /* @__PURE__ */ new WeakMap(), this.viewModel = new v5(), this.messages = null, this._disposeChart = (e15) => {
      this._chartRootMap.get(e15)?.dispose(), this._chartRootMap.delete(e15);
    }, this._createChart = async (e15) => {
      const { destroyed: t6, viewModel: i11 } = this;
      if (t6 || !i11 || !e15) return;
      const { createRoot: r7 } = await import("./chartUtilsAm5-MFIHZABO.js"), a7 = await r7(e15);
  ...
  _renderMedia() {
    const { formattedMediaInfoCount: e14, activeMediaInfoIndex: t5 } = this.viewModel, i11 = this._renderMediaText();
    return e14 ? n2("div", { class: M3.mediaContainer, key: "media-element-container" }, this._renderMediaInfo(), n2("div", { class: M3.mediaNavigation }, i11, e14 > 1 ? n2("div", { class: M3.mediaPagination }, this._renderMediaPageButton("previous"), n2("span", { class: M3.mediaPaginationText }, s3(this.messages.pageText, { index: t5 + 1, total: e14 })), this._renderMediaPageButton("next")) : null)) : null;
  }
  _renderMediaText() {
    const { activeMediaInfo: e14 } = this.viewModel;
    if (!e14) return null;
    const t5 = e14 && e14.title ? n2("div", { class: M3.mediaItemTitle, innerHTML: e14.title, key: "media-title" }) : null, i11 = e14 && e14.caption ? n2("div", { class: M3.mediaItemCaption, innerHTML: e14.caption, key: "media-caption" }) : null;
    return t5 || i11 ? n2("div", { class: M3.mediaItemText, key: "media-text" }, t5, i11) : null;
  }
  _renderImageMediaInfo(e14) {
    if (!e14.value) return null;
    const { _refreshIntervalInfo: t5 } = this, { activeMediaInfoIndex: i11, formattedMediaInfoCount: r7 } = this.viewModel, { value: a7, refreshInterval: o5, altText: s12, title: n13, type: l5 } = e14, { sourceURL: d10, linkURL: c14 } = a7, h8 = x2(c14 ?? void 0) ? "_blank" : "_self", p10 = "_blank" === h8 ? "noreferrer" : "", f8 = o5 ? t5 : null, g8 = f8 ? f8.timestamp : 0, _5 = f8 ? f8.sourceURL : d10, M5 = n2("img", { alt: s12 || n13, key: `media-${l5}-${i11}-${r7}-${g8}`, src: _5 ?? void 0 });
    return (c14 ? n2("a", { href: c14, rel: p10, target: h8, title: n13 }, M5) : null) ?? M5;
  }
  _renderChartMediaInfo(e14) {
    const { activeMediaInfoIndex: t5, formattedMediaInfoCount: i11 } = this.viewModel;
    return n2("div", { afterCreate: this._createChart, afterRemoved: this._disposeChart, bind: this, class: M3.mediaChart, key: `media-${e14.type}-${t5}-${i11}` });
  }
  ...
  _renderMediaPageButton(e14) {
    ...
    const t5 = "previous" === e14, i11 = t5 ? this.messages.previous : this.messages.next, r7 = t5 ? "chevron-left" : "chevron-right", a7 = t5 ? "media-previous" : "media-next", o5 = t5 ? this._previous : this._next;
  ...
  _getRenderer() {
    ...
    return e14 && t5?.featureReduction && "renderer" in t5.featureReduction ? t5.featureReduction.renderer : t5?.renderer;
  }
  async _getSeriesColors(e14) {
    const { colorAm5: t5 } = await import("./chartCommon-KGGC22AP.js"), i11 = /* @__PURE__ */ new Map();
    return e14.forEach(((e15) => {
      e15.color && i11.set(e15, t5(e15.color.toCss(true)));
    })), i11;
  }
  async _getRendererColors() {
    const { colorAm5: e14 } = await import("./chartCommon-KGGC22AP.js"), t5 = /* @__PURE__ */ new Map(), i11 = this._getRenderer(), r7 = "default";
    if (!i11) return t5;
  ...
  async _renderChart(e14) {
    const { root: t5, mediaInfo: i11 } = e14, { value: r7, type: a7 } = i11, { ResponsiveThemeAm5: o5, DarkThemeAm5: s12, AnimatedThemeAm5: n13, ColorSetAm5: l5, ThemeAm5: d10, esriChartColorSet: m6 } = await import("./chartCommon-KGGC22AP.js"), c14 = d10.new(t5);
    c14.rule("ColorSet").set("colors", m6), c14.rule("ColorSet").set("reuse", true);
    const h8 = [o5.new(t5), c14];
    s5() && h8.push(s12.new(t5)), this._canAnimateChart() && h8.push(n13.new(t5)), t5.setThemes(h8);
    const p10 = await this._getRendererColors(), u10 = await this._getSeriesColors(r7.series), g8 = l5.new(t5, {}), _5 = u10.get(r7.series[0]), M5 = _5 ? { lineSettings: { stroke: _5 } } : void 0, v9 = r7.series.map(((e15, t6) => {
      const i12 = u10.get(e15) || p10.get(e15.fieldName) || g8.getIndex(t6);
  ...
  async _customizeChartTooltip(e14, t5 = "horizontal") {
    const { colorAm5: i11 } = await import("./chartCommon-KGGC22AP.js");
    e14.setAll({ pointerOrientation: t5 }), e14.get("background")?.setAll({ stroke: i11(I4) }), e14.label.setAll({ direction: this._getDirection(), oversizedBehavior: "wrap", maxWidth: x4 });
  }
  async _createPieChart(e14, t5) {
    const { TooltipAm5: i11 } = await import("./chartCommon-KGGC22AP.js"), { PieChartAm5: r7, PieSeriesAm5: a7 } = await import("./pieChart-KOZ6ED6U.js"), { mediaInfo: o5, root: s12 } = e14, { title: n13 } = o5, l5 = 5, d10 = o5?.altText || o5?.title || "", m6 = s12.container.children.push(r7.new(s12, { ariaLabel: d10, focusable: true, paddingBottom: l5, paddingTop: l5, paddingLeft: l5, paddingRight: l5 })), c14 = "{category}: {valuePercentTotal.formatNumber('0.00')}%\n ({value})", h8 = i11.new(s12, { labelText: c14 }), p10 = m6.series.push(a7.new(s12, { name: n13, valueField: A4, categoryField: w5, tooltip: h8 }));
    p10.ticks.template.set("forceHidden", true), p10.labels.template.set("forceHidden", true), p10.slices.template.states.create("active", { shiftRadius: l5 }), this._customizeChartTooltip(h8), p10.slices.template.setAll({ ariaLabel: c14, focusable: true, templateField: "columnSettings" }), p10.data.setAll(t5), p10.appear(this._getChartSeriesAnimationMS()), m6.appear(this._getChartAnimationMS()), m6.root.dom.classList.toggle(M3.mediaChartRendered, true);
  }
  _getMinSeriesValue(e14) {
    let t5 = 0;
    return e14.forEach(((e15) => t5 = Math.min(e15.value, t5))), t5;
  }
  async _createColumnChart(e14, t5, i11) {
    const { TooltipAm5: r7, ScrollbarAm5: a7 } = await import("./chartCommon-KGGC22AP.js"), { CategoryAxisAm5: o5, AxisRendererXAm5: s12, ValueAxisAm5: n13, AxisRendererYAm5: l5, ColumnSeriesAm5: d10 } = await import("./xyChart-LCMO2Q4F.js"), { mediaInfo: m6, root: c14 } = t5, { value: p10, title: u10 } = m6;
  ...
  async _createBarChart(e14, t5, i11) {
    const { TooltipAm5: r7, ScrollbarAm5: a7 } = await import("./chartCommon-KGGC22AP.js"), { CategoryAxisAm5: o5, AxisRendererXAm5: s12, ValueAxisAm5: n13, AxisRendererYAm5: l5, ColumnSeriesAm5: d10 } = await import("./xyChart-LCMO2Q4F.js"), { mediaInfo: m6, root: c14 } = t5, { value: p10, title: u10 } = m6;
  ...
  async _createLineChart(e14, t5, i11) {
    const { TooltipAm5: r7, ScrollbarAm5: a7 } = await import("./chartCommon-KGGC22AP.js"), { CategoryAxisAm5: o5, AxisRendererXAm5: s12, ValueAxisAm5: n13, AxisRendererYAm5: l5, LineSeriesAm5: d10 } = await import("./xyChart-LCMO2Q4F.js"), { root: m6, mediaInfo: c14 } = t5, { value: p10, title: u10 } = c14;
    e14.setAll({ wheelX: "panX", wheelY: "zoomX" });
  ...
  async _createXYChart(e14, t5) {
    const { XYChartAm5: i11, XYCursorAm5: r7 } = await import("./xyChart-LCMO2Q4F.js"), { root: a7, mediaInfo: o5 } = e14, { type: s12 } = o5, n13 = o5?.altText || o5?.title || "", l5 = a7.container.children.push(i11.new(a7, { ariaLabel: n13, focusable: true, panX: true, panY: true }));
    l5.set("cursor", r7.new(a7, {})), "column-chart" === s12 && await this._createColumnChart(l5, e14, t5), "bar-chart" === s12 && await this._createBarChart(l5, e14, t5), "line-chart" === s12 && await this._createLineChart(l5, e14, t5), l5.root.dom.classList.toggle(M3.mediaChartRendered, true);
  }
  ...
  _setRefreshTimeout(e14) {
    const { refreshInterval: t5, value: i11 } = e14, r7 = 6e4 * t5;
  ...
  _getImageSource(e14, t5) {
    ...
    return `${r7}${i11}timestamp=${t5}${a7 ? "#" : ""}${a7}`;
  }
};
...
function e9(e14, t5, l5, n13) {
  let o5 = null, p10 = 1e3;
  "number" == typeof t5 ? (p10 = t5, n13 = l5) : (o5 = t5 ?? null, p10 = l5);
  let r7, u10 = 0;
  const a7 = () => {
...
function u6(e14) {
  const r7 = e14.keys().map(((r8) => {
    const t5 = e14.field(r8);
    return `<tr><th>${r8}</th><td>${"string" == typeof t5 ? le(ae(t5)) : t5}</td></tr>`;
  })).join("");
  return `<table class="${e4.table}">${r7}</table>`;
}
async function l4() {
  const [e14, r7] = await Promise.all([import("./arcade-OORX3I2Y.js"), import("./arcade-LRIKWRCD.js")]);
  return { executor: e14, syntaxUtils: r7 };
}
function d8(e14) {
  return "createQuery" in e14 && "queryFeatures" in e14;
}
async function y6({ graphic: e14, view: r7, options: t5 }) {
  ...
  const { features: c14 } = await s12.queryFeatures(o5, t5);
  return c14;
}
...
async function x5(e14, r7, t5, a7, n13) {
  let s12 = null;
  if (n13.has("$aggregatedfeatures")) {
    const n14 = await y6({ graphic: e14, view: r7, options: t5 }), o5 = e14.sourceLayer || e14.layer;
...
function v7(r7, t5, a7, n13) {
  const s12 = (r7.sourceLayer || r7.layer) ?? void 0;
  return { $feature: r7, $layer: null != s12 && x(s12) ? s12 : "scene" === s12?.type && null != s12.associatedLayer ? s12.associatedLayer : void 0, $map: t5, $datastore: s12?.url, $userInput: a7, $graph: "knowledge-graph-sublayer" === s12?.type ? s12?.parentCompositeLayer?.knowledgeGraph : void 0, $view: w6(n13) };
}
async function h6(e14, { graphic: r7, map: t5, location: a7, view: n13, options: s12, interceptor: o5, arcadeExecutor: i11 }) {
  switch (e14) {
    case "popup":
      return { vars: v7(r7, t5, a7, n13), [Symbol.dispose]() {
      } };
...
async function $3({ expressionInfo: e14, arcade: { executor: r7, syntaxUtils: t5 }, graphic: a7 }) {
  ...
  return c14.variablesUsed.includes("$view") && (t5.scriptUsesViewProperties(c14.syntaxTree, ["scale"]) && p10.add("view-scale"), t5.scriptUsesViewProperties(c14.syntaxTree, ["timeProperties"]) && p10.add("view-time-extent")), { dependencies: p10, async evaluate({ graphic: r8, interceptor: t6, location: a8, map: n14, options: o6, spatialReference: p11, view: l5 }) {
    const d10 = await h6(s12, { graphic: r8, map: n14, location: a8, view: l5, options: o6, interceptor: t6, arcadeExecutor: c14 }), y10 = { abortSignal: o6?.signal ?? void 0, interceptor: t6 ?? void 0, rawOutput: true, spatialReference: p11 ?? void 0, timeZone: l5?.timeZone, console(...e15) {
      i8().info(...e15);
    } };
    try {
...
async function b5(e14, r7) {
  ...
  const t5 = await l4(), a7 = /* @__PURE__ */ new Set(), n13 = /* @__PURE__ */ new Map();
  for (const s12 of e14) {
    const e15 = await $3({ expressionInfo: s12, arcade: t5, graphic: r7 });
...
var g3 = class extends b2 {
  constructor(t5) {
    super(t5), this._compileTask = null, this._evaluateTask = null, this.expressionInfo = null, this.graphic = null, this.contentElementViewModel = null, this.interceptor = null, this.location = null, this.view = null, this._createVM = () => {
      const t6 = this.contentElement?.type;
      this.contentElementViewModel?.destroy();
      const e14 = "fields" === t6 ? new l3() : "media" === t6 ? new v5() : "text" === t6 ? new c8() : null;
      ...
      const t6 = this._compileTask.value, e14 = t6?.dependencies;
      return [t6, this.spatialReference, this.map, this.view, e14?.has("view-scale") ? this.view?.scale : null, e14?.has("view-time-extent") ? this.view?.timeExtent?.start : null, e14?.has("view-time-extent") ? this.view?.timeExtent?.end : null];
  ...
  get state() {
    ...
    return this._compileThrottled.hasPendingUpdates() || this._evaluateThrottled.hasPendingUpdates() || !this._compileTask?.finished || !this._evaluateTask?.finished ? "loading" : t5 || e14 ? "ready" : "disabled";
  }
  get map() {
  ...
  _startEvaluate(t5) {
    this._evaluateTask = e(this._evaluateTask), this._evaluateTask = d2((async (e14) => {
      ...
      if (!t5 || !o5) return null;
      const { interceptor: s12, spatialReference: i11, map: r7, location: a7, view: l5 } = this, p10 = await t5.evaluate({ graphic: o5, interceptor: s12, location: a7, map: r7, options: { signal: e14 }, spatialReference: i11, view: l5 });
      s2(e14);
      const c14 = p10;
...
var g4 = class extends O {
  constructor(e14, t5) {
    super(e14, t5), this._contentWidget = null, this.viewModel = new g3();
  }
  initialize() {
    this.addHandles(l((() => this.viewModel?.contentElementViewModel), (() => this._setupExpressionWidget()), h2));
  }
  loadDependencies() {
    return c3({ loader: () => import("./calcite-loader-K4VGO2P2.js") });
  }
  destroy() {
  ...
  _setupExpressionWidget() {
    const { contentElementViewModel: e14, contentElement: t5 } = this.viewModel, o5 = t5?.type;
    this._destroyContentWidget();
...
var _4 = class extends a3.ClonableMixin(n3.IdentifiableMixin(b2)) {
  constructor(e14) {
    super(e14), this._loaded = false, this._queryAbortController = null, this._queryPageAbortController = null, this._queryFeatureCountAbortController = null, this.featuresPerPage = 10, this.activeCategory = null, this.allCategories = null, this.description = null, this.graphic = null, this.layer = null, this.map = null, this.orderByFields = null, this.featureCount = 0, this.relationshipId = null, this.showAllEnabled = false, this.title = null, this._cancelQuery = () => {
      ...
      this.featureCount && ("subtype-group" !== this.relatedLayer?.type || this.activeCategory) && (this._destroyRelatedFeatureViewModels(), this.featurePage = 1, t5.destroyAll(), this.destroyed || t5.addMany(this._sliceFeatures(await this._queryRelatedFeatures({ signal: e15?.signal }))));
  ...
  set featurePage(e14) {
    const { featuresPerPage: t5, featureCount: r7 } = this, o5 = 1, l5 = Math.ceil(r7 / t5) || 1;
  ...
  get orderByFieldsFixedCasing() {
    ...
    return e14 && t5?.loaded ? e14.map(((e15) => {
      const r7 = e15.clone();
      return r7.field = M(e15.field, t5), r7;
    })) : e14 ?? [];
  }
  ...
  set displayCount(e14) {
    const t5 = 0, r7 = 10, o5 = 3;
    this._set("displayCount", Math.min(Math.max(e14 ?? o5, t5), r7));
  }
  get displayCount() {
  ...
  get relatedLayer() {
    const { layer: e14, map: t5, relationship: r7 } = this;
    if (!e14?.loaded || !t5 || !r7) return null;
    const o5 = "subtype-sublayer" === e14.type && e14.parent && J(e14.parent) ? e14.parent : e14;
    return Te(t5, o5, r7) ?? null;
  }
  get relatedLayerKeyField() {
    const { relatedLayer: e14, relationshipId: t5 } = this;
    return e14?.loaded && null != t5 ? e14.relationships?.find(((e15) => e15.id === t5))?.keyField : null;
  }
  ...
  get relationship() {
    ...
    return null != e14 && t5?.loaded ? t5.relationships?.find((({ id: t6 }) => t6 === e14)) ?? null : null;
  }
  get relationshipKey() {
  ...
  get state() {
    const { _queryAbortController: e14, _queryFeatureCountAbortController: t5, _queryPageAbortController: r7, canQuery: o5, _loaded: l5, canLoad: a7 } = this;
    return t5 || a7 && !l5 ? "loading" : e14 || r7 ? "querying" : o5 ? "ready" : "disabled";
  }
  ...
  async _queryFeatureCount() {
    ...
    if (!a7 || !e14 || !t5 || null == i11) return this._set("featureCount", 0), void this._set("allCategories", null);
    if ("subtype-group" === t5?.type && !l5) {
      if (this._set("featureCount", 0), this._destroyRelatedFeatureViewModels(), this.featurePage = 1, this.relatedFeatures.destroyAll(), s12 && null != u10) {
        const { default: e15 } = await import("./uniqueValues-ZPYJZVWZ.js"), { uniqueValueInfos: l6 } = await e15({ layer: t5, sqlWhere: `${s12} = '${u10}'`, field: t5.subtypeField, signal: r7?.signal }), a8 = l6.map((({ count: e16, value: r8 }) => {
          const o5 = t5.subtypes?.find(((e17) => e17.code === r8))?.name;
    ...
    const { historicMoment: y10, gdbVersion: h8 } = e14, c14 = new c5({ cacheHint: d10, gdbVersion: h8, historicMoment: y10, relationshipId: n13, returnGeometry: false, objectIds: [i11], where: this._getRelationshipWhereClause(t5) }), g8 = await e14.queryRelatedFeaturesCount(c14, { signal: r7?.signal });
    this._set("allCategories", null), this._set("featureCount", g8[i11] || 0);
  }
  _getRelationshipWhereClause(e14) {
    const { activeCategory: t5 } = this, r7 = e14.createQuery(), o5 = "subtypeField" in e14 ? e14.subtypeField : void 0, l5 = t5 && o5 ? `${o5} = ${t5.value}` : void 0, a7 = r7.where;
    return a7 && l5 ? `(${a7}) AND (${l5})` : a7 ?? l5;
  }
  _sliceFeatures(e14) {
    const { showAllEnabled: t5, displayCount: r7 } = this;
    return t5 ? e14 : r7 ? e14.slice(0, r7) : [];
  }
  async _queryPage() {
    const { relatedFeatures: e14, featurePage: t5, showAllEnabled: r7, _queryPageAbortController: o5, featureCount: l5 } = this;
    !r7 || t5 < 2 || !l5 || "subtype-group" === this.relatedLayer?.type && !this.activeCategory || e14.addMany(await this._queryRelatedFeatures({ signal: o5?.signal }));
  }
  async _queryRelatedFeatures(e14) {
    const { displayCount: t5, featureCount: r7, featurePage: o5, featuresPerPage: l5, layer: a7, orderByFieldsFixedCasing: i11, relatedLayer: s12, relatedLayerKeyFields: n13, relationshipId: u10, showAllEnabled: d10, supportsCacheHint: y10 } = this, { canQuery: h8, objectId: c14 } = this;
    if (!h8 || !a7 || !s12 || null == c14) return [];
    const g8 = d10 ? ((o5 - 1) * l5 + r7) % r7 : 0, C4 = d10 ? l5 : t5, F9 = s12.objectIdField, _5 = "subtypeField" in s12 ? s12.subtypeField : void 0, m6 = [...i11.map(((e15) => e15.field)), ...J2(s12), ...n13, F9, _5].filter(f6), q3 = i11.map(((e15) => `${e15.field} ${e15.order}`)), { historicMoment: A5, gdbVersion: w7 } = a7, P = new c5({ orderByFields: q3, start: g8, num: C4, outFields: m6, cacheHint: y10, historicMoment: A5, gdbVersion: w7, relationshipId: u10, returnGeometry: false, objectIds: [c14], where: this._getRelationshipWhereClause(s12) }), v9 = await a7.queryRelatedFeatures(P, { signal: e14?.signal }), j3 = v9[c14]?.features || [];
    return "subtype-group" === s12.type && _5 ? j3.forEach(((e15) => {
      const t6 = e15.attributes[_5], r8 = s12.findSublayerForSubtypeCode?.(t6);
...
var M4 = b7 = class extends O {
  constructor(e14, t5) {
    super(e14, t5), this._featureElementInfo = null, this._relatedFeatureIntersectionObserverNode = null, this._relatedFeatureIntersectionObserver = new IntersectionObserver((([e15]) => {
      ...
      const { state: e15, showAllEnabled: t6, relatedFeatures: s12, featuresPerPage: i11, featurePage: r7 } = this.viewModel;
      "ready" === e15 && t6 && s12.length >= i11 * r7 && this.viewModel.featurePage++;
    };
  }
  initialize() {
  ...
  loadDependencies() {
    return c3({ chip: () => import("./calcite-chip-7XJU4TKW.js"), icon: () => import("./calcite-icon-JQPP5WAE.js"), list: () => import("./calcite-list-XFVCKEJA.js"), "list-item": () => import("./calcite-list-item-DSNVAE4G.js"), loader: () => import("./calcite-loader-K4VGO2P2.js"), notice: () => import("./calcite-notice-I3FL54AY.js") });
  }
  destroy() {
    this._unobserveRelatedFeatureObserver(), this._featureElementInfo = u2(this._featureElementInfo);
  }
  get displayShowAllButton() {
    const { showAllEnabled: e14, featureCount: t5, displayCount: s12, state: i11, allCategoriesCount: r7 } = this.viewModel;
    return !e14 && "ready" === i11 && (!!r7 && (r7 > s12 || 0 === s12) || !!t5 && (t5 > s12 || 0 === s12));
  }
  ...
  get allItemsDescription() {
    const { messages: e14 } = this, { featureCount: t5, allCategories: s12, allCategoriesCount: i11 } = this.viewModel;
    return s3(e14?.numberRecords, { number: o(s12 ? i11 : t5) });
  }
  get description() {
    return this.viewModel.description;
  }
  ...
  async _selectCategory(e14) {
    const { flowItems: t5, featureVisibleElements: s12, viewModel: i11 } = this;
    t5 && (i11.activeCategory = e14, i11.showAllEnabled = true, t5.push(new b7({ flowItems: t5, featureVisibleElements: s12, visibleElements: { title: false, description: false }, viewModel: i11 })));
  }
  async _selectRecord(e14) {
    const { flowItems: t5, featureVisibleElements: s12 } = this;
    if (!t5) return;
    e14.abilities = { relationshipContent: true };
    const { default: i11 } = await import("./Feature-DUNEXMWX.js");
    t5.push(new i11({ flowItems: t5, flowType: this.flowType, viewModel: e14, visibleElements: s12 }));
  }
  _showAllRecords() {
    const { flowItems: e14 } = this;
    if (!e14) return;
    const { viewModel: t5, featureVisibleElements: s12 } = this;
    t5.showAllEnabled = true;
    const i11 = new b7({ flowItems: e14, featureVisibleElements: s12, visibleElements: { title: false, description: false }, viewModel: t5 });
    e14.push(i11);
  }
  ...
  _renderCategory(e14) {
    const { count: t5, name: s12, value: i11 } = e14, r7 = o(t5);
    return n2("calcite-list-item", { class: F7.listItem, disabled: !t5, key: i11, label: s12, onCalciteListItemSelect: () => this._selectCategory(e14) }, n2("calcite-chip", { label: r7, scale: "s", slot: "content-end" }, r7), this._renderChevronIconNode());
  }
  _renderRelatedFeature(e14) {
    const { itemDescriptionFieldName: t5 } = this.viewModel, s12 = e14.title;
    e14.description = t5 && e14.formattedAttributes?.global[t5];
  ...
  _renderList() {
    ...
    return n2("calcite-list", { displayMode: "flat", label: this.messages?.relatedFeaturesList }, t5?.map(((e15) => this._renderCategory(e15))) ?? e14.toArray().map(((e15) => this._renderRelatedFeature(e15))), this._renderShowAllListItem());
  }
  _renderRelatedFeatures() {
    const { displayListItems: e14 } = this, { state: t5 } = this.viewModel;
    return n2("div", { class: this.classes(F7.listContainer, { [F7.listContainerQuerying]: "querying" === t5 }), key: "list-container" }, e14 ? this._renderList() : "ready" === t5 ? this._renderNoRelatedFeaturesMessage() : null, this._renderStickyLoading(), this._renderFeatureObserver());
  }
  ...
  _setupRelatedFeatureViewModels() {
    ...
    this.removeHandles(t5), e14?.forEach(((e15) => {
      this.addHandles(l((() => [e15.title, e15.state]), (() => this.scheduleRender()), h2), t5);
    })), this.scheduleRender();
  }
  _setupFeatureElementInfo() {
    const { headingLevel: e14, visibleElements: t5 } = this, s12 = t5.description && this.description, i11 = t5.title && this.title;
...
var v8 = class extends O {
  ...
  loadDependencies() {
    return c3({ icon: () => import("./calcite-icon-JQPP5WAE.js"), list: () => import("./calcite-list-XFVCKEJA.js"), "list-item": () => import("./calcite-list-item-DSNVAE4G.js"), loader: () => import("./calcite-loader-K4VGO2P2.js"), notice: () => import("./calcite-notice-I3FL54AY.js") });
  }
  destroy() {
  ...
  _renderAssociationType(e14) {
    const { viewModel: t5 } = this, i11 = this._getAssociationTypeTitle(e14);
    return n2("calcite-list-item", { description: c2(e14.description), key: `association-type-${e14.type}`, label: c2(i11), value: e14.type, onCalciteListItemSelect: () => this.onSelectAssociationType({ viewModel: t5, listType: e14, title: i11 }) }, n2("calcite-icon", { flipRtl: true, icon: "chevron-right", scale: "s", slot: "content-end" }));
  }
  ...
  _renderContent() {
    const { messages: e14, viewModel: t5 } = this, { state: i11, associationTypes: o5 } = t5;
  ...
  _setupFeatureElementInfo() {
    const { headingLevel: e14, visibleElements: t5 } = this, i11 = t5.description && this.description, o5 = t5.title && this.title;
...
var ne2 = (_a = class extends n3.IdentifiableMixin(b2) {
  constructor(e14) {
    super(e14), this._error = null, this._graphicChangedTask = null, this._evaluateExpressionAttributesTask = null, this._associationVMAbortController = null, this._expressionAttributes = null, this._graphicExpressionAttributes = null, this.abilities = { ...ae2 }, this.content = null, this.contentViewModels = [], this.description = null, this.defaultPopupTemplateEnabled = false, this.formattedAttributes = null, this.lastEditInfo = null, this.location = null, this.relatedInfos = /* @__PURE__ */ new Map(), this.title = "", this.view = null, this._graphicChangedThrottled = e9(this._graphicChanged, (() => this.notifyChange("waitingForContent")), ie2, this), this._isAllowedContentType = (e15) => {
      ...
      const e15 = this._graphicChangedTask.value, t5 = e15?.expressionInfos?.dependencies;
      return [e15, t5?.has("view-scale") ? this.view?.scale : null, t5?.has("view-time-extent") ? this.view?.timeExtent?.start : null, t5?.has("view-time-extent") ? this.view?.timeExtent?.end : null];
  ...
  get waitingForContent() {
    const { _graphicChangedThrottled: e14, _evaluateExpressionAttributesThrottled: t5, _graphicChangedTask: i11, _evaluateExpressionAttributesTask: s12, _associationVMAbortController: o5 } = this;
    return e14.hasPendingUpdates() || t5.hasPendingUpdates() || null != i11 && !i11.finished || null != s12 && !s12.finished || !!o5;
  }
  setActiveMedia(e14, t5) {
    const i11 = this.contentViewModels[e14];
    i11 instanceof v5 && i11.setActiveMedia(t5);
  }
  nextMedia(e14) {
    const t5 = this.contentViewModels[e14];
    t5 instanceof v5 && t5.next();
  }
  previousMedia(e14) {
    const t5 = this.contentViewModels[e14];
    t5 instanceof v5 && t5.previous();
  }
  async updateGeometry() {
    const { graphic: e14, spatialReference: t5, _sourceLayer: i11 } = this;
    await i11?.load();
    ...
    const r7 = [o5];
    if (!e14.geometry) {
      const s13 = await fe({ layer: i11, graphic: e14, outFields: [], objectIds: r7, returnGeometry: true, spatialReference: t5 }), o6 = s13?.geometry;
      o6 && (e14.geometry = o6);
    }
  }
  _clear() {
  ...
  _graphicChanged() {
    this._evaluateExpressionAttributesTask = e(this._evaluateExpressionAttributesTask), this._graphicChangedTask = e(this._graphicChangedTask), this._graphicChangedTask = d2((async (e14) => {
      ...
      try {
        ...
        await de({ graphic: t5, popupTemplate: s12, layer: i11, spatialReference: o5 }, { signal: e14 });
        const [{ value: r7 }, { value: a7 }] = await y([this._getContent(), this._getTitle()]), [, { value: n13 }] = await y([this._checkForRelatedFeatures({ signal: e14 }), b5(s12?.expressionInfos, t5)]);
        return { expressionInfos: n13, content: r7, title: a7 };
      } catch (i11) {
        throw b(i11) || (this._error = i11, i2.getLogger(this).error("error", "The popupTemplate could not be displayed for this feature.", { error: i11, graphic: t5, popupTemplate: this._effectivePopupTemplate })), i11;
      }
    }));
  }
  ...
  _compileContent(e14) {
    if (this._destroyContentViewModels(), this.graphic) return Array.isArray(e14) ? e14.filter(this._isAllowedContentType).map(((e15, t5) => this._compileContentElement(e15, t5))).filter(L) : "string" == typeof e14 ? this._compileText(new c4({ text: e14 }), 0).text : e14;
  }
  ...
  _matchesFeature(e14, t5) {
    const i11 = e14?.graphic?.getObjectId(), s12 = t5?.getObjectId();
    return null != i11 && null != s12 && i11 === s12;
  }
  _setRelatedFeaturesViewModels({ relatedFeatureViewModels: e14, relatedFeatures: t5, map: i11 }) {
    const { view: s12, spatialReference: o5, timeZone: r7 } = this;
    t5?.filter(Boolean).forEach(((t6) => {
      e14.some(((e15) => this._matchesFeature(e15, t6))) || e14.add(new te({ abilities: { relationshipContent: false }, map: i11, view: s12, spatialReference: o5, timeZone: r7, graphic: t6 }));
    })), e14.forEach(((i12) => {
      const s13 = t5?.find(((e15) => this._matchesFeature(i12, e15)));
      s13 || e14.remove(i12);
    }));
  }
  _setExpressionContentVM(e14, t5) {
    ...
    o5 && r7 && ("fields" === r7 && (this._createFieldsFormattedAttributes({ contentElement: s12, contentElementIndex: t5, formattedAttributes: i11 }), o5.set(this._createFieldsVMParams(s12, t5))), "media" === r7 && (this._createMediaFormattedAttributes({ contentElement: s12, contentElementIndex: t5, formattedAttributes: i11 }), o5.set(this._createMediaVMParams(s12, t5))), "text" === r7 && o5.set(this._createTextVMParams(s12)));
  }
  _compileRelationship(e14, t5) {
    ...
    return this.contentViewModels[t5] = c14, this.addHandles(a2((() => c14.relatedFeatures), "change", (() => this._setRelatedFeaturesViewModels(c14))), oe2), e14;
  }
  _matchesGlobalFeature(e14, t5) {
    const i11 = e14?.association.globalId, s12 = t5?.association.globalId;
    return null != i11 && null != s12 && i11 === s12;
  }
  async _setUpUtilityNetworkAssociationsViewModels(e14, t5, i11) {
    const { view: s12, spatialReference: o5, timeZone: r7 } = this;
    e14.forEach(((i12, s13) => {
      const o6 = t5.get(s13);
      o6 ? i12.forEach(((t6) => {
        o6.find(((e15) => this._matchesGlobalFeature(t6, e15))) || (i12.remove(t6), 0 === i12.length && e14.delete(s13));
      })) : (i12.removeAll(), e14.delete(s13));
    })), t5.forEach(((t6, n13) => {
      const l5 = e14.get(n13) || new V();
      t6?.filter(Boolean).forEach(((e15) => {
        if (!l5.some(((t7) => this._matchesGlobalFeature(t7, e15)))) {
          const { association: t7, feature: a7, terminalName: n14, title: p10 } = e15;
          l5.add({ title: p10, association: t7, featureViewModel: new te({ abilities: { utilityNetworkAssociationsContent: false }, map: i11, view: s12, spatialReference: o5, timeZone: r7, graphic: a7 }), terminalName: n14 });
        }
      })), e14.set(n13, l5);
    })), this._sortListObjectsByTitle(e14);
  }
  async _sortListObjectsByTitle(e14) {
    for (const t5 of e14.values()) t5.sort(this._compareByFeatureTitle);
  }
  _compareByFeatureTitle(e14, t5) {
    return e14.title.localeCompare(t5.title, void 0, { numeric: true });
  }
  _compileUtilityNetworkAssociation(e14, t5) {
    ...
    return this.contentViewModels[t5] = p10, this.addHandles([l((() => p10.associationFeatures.values()), (() => this._setUpUtilityNetworkAssociationsViewModels(p10.associationViewModels, p10.associationFeatures, p10.map)))], re), e14;
  }
  _compileExpression(e14, t5) {
    ...
    return this.contentViewModels[t5] = l5, this.addHandles(l((() => l5.contentElementViewModel), (() => this._setExpressionContentVM(l5, t5)), h2), se2), e14;
  }
  _compileAttachments(e14, t5) {
    const { graphic: i11 } = this, { description: s12, title: o5, orderByFields: r7 } = e14;
    return this.contentViewModels[t5] = new s8({ graphic: i11, orderByFields: r7, ...this._compileTitleAndDesc({ title: o5, description: s12 }) }), e14;
  }
  _compileCustom(e14, t5) {
    const { graphic: i11 } = this, { creator: s12, destroyer: o5 } = e14;
    return this.contentViewModels[t5] = new c8({ graphic: i11, creator: s12, destroyer: o5 }), e14;
  }
  _compileTitleAndDesc({ title: e14, description: t5 }) {
    ...
    return { title: D({ attributes: a7, fieldInfoMap: i11, globalAttributes: l5, expressionAttributes: n13, layer: s12, text: e14 }), description: D({ attributes: a7, fieldInfoMap: i11, globalAttributes: l5, expressionAttributes: n13, layer: s12, text: t5 }) };
  }
  _createFieldsVMParams(e14, t5) {
    const i11 = this._effectivePopupTemplate, s12 = this.formattedAttributes, o5 = { ...s12?.global, ...s12?.content[t5] }, r7 = e14?.fieldInfos || i11?.fieldInfos, a7 = r7?.filter((({ fieldName: e15 }) => !!e15 && (E(e15) || pe(e15) || o5.hasOwnProperty(e15)))), n13 = i11?.expressionInfos, { description: l5, title: p10 } = e14;
  ...
  _compileFields(e14, t5) {
    const i11 = e14.clone(), s12 = new l3(this._createFieldsVMParams(e14, t5));
    return this.contentViewModels[t5] = s12, i11.fieldInfos = s12.formattedFieldInfos.slice(), i11;
  }
  _createMediaVMParams(e14, t5) {
    ...
    return { abilities: { chartAnimation: i11.chartAnimation }, activeMediaInfoIndex: e14.activeMediaInfoIndex || 0, attributes: c14, isAggregate: s12?.isAggregate, layer: n13, fieldInfoMap: o5, formattedAttributes: { ...p10?.global, ...p10?.content[t5] }, expressionAttributes: l5, mediaInfos: h8, popupTemplate: r7, relatedInfos: a7, ...this._compileTitleAndDesc({ title: u10, description: d10 }) };
  }
  _compileMedia(e14, t5) {
    const i11 = e14.clone(), s12 = new v5(this._createMediaVMParams(e14, t5));
    return i11.mediaInfos = s12.formattedMediaInfos.slice(), this.contentViewModels[t5] = s12, i11;
  }
  _createTextVMParams(e14) {
    const { graphic: t5, _fieldInfoMap: i11, _sourceLayer: s12, _expressionAttributes: o5 } = this;
    if (e14 && e14.text) {
      const r7 = t5?.attributes ?? {}, a7 = this.formattedAttributes?.global ?? {};
  ...
  _compileText(e14, t5) {
    const i11 = e14.clone();
    return this.contentViewModels[t5] = new c8(this._createTextVMParams(i11)), i11;
  }
  _compileLastEditInfo() {
    const { _effectivePopupTemplate: e14, _sourceLayer: t5, graphic: i11, timeZone: s12 } = this;
    if (!e14) return;
    const { lastEditInfoEnabled: o5 } = e14, r7 = t5?.editFieldsInfo;
    return o5 && r7 ? ne(r7, i11?.attributes, s12, t5) : void 0;
  }
  _compileTitle(e14) {
    const { _fieldInfoMap: t5, _sourceLayer: i11, graphic: s12, _expressionAttributes: o5 } = this, r7 = s12?.attributes ?? {}, a7 = this.formattedAttributes?.global ?? {};
    return D({ attributes: r7, fieldInfoMap: t5, globalAttributes: a7, expressionAttributes: o5, layer: i11, text: e14 });
  }
  async _getTitle() {
    const { _effectivePopupTemplate: e14, graphic: t5 } = this;
    return t5 ? q({ type: "title", value: e14?.title, event: { graphic: t5 } }) : null;
  }
  async _getContent() {
    const { _effectivePopupTemplate: e14, graphic: t5 } = this;
    return t5 ? q({ type: "content", value: e14?.content, event: { graphic: t5 } }) : null;
  }
  _evaluateExpressionAttributes({ title: e14, content: t5, expressionInfos: i11 }) {
    this._evaluateExpressionAttributesTask = e(this._evaluateExpressionAttributesTask), this._evaluateExpressionAttributesTask = d2((async (s12) => {
      ...
      try {
        ...
        if (null != i11) {
          const e15 = [];
          for (const [t6, l6] of i11.expressions.entries()) null != l6 ? e15.push(l6.evaluate({ graphic: o5, interceptor: te.interceptor, location: p10, map: r7, options: { signal: s12 }, spatialReference: n13, view: a7 }).then(((e16) => [t6, c12(e16)])).catch((() => [t6, void 0]))) : e15.push(Promise.resolve([t6, void 0]));
          l5 = Object.fromEntries(await Promise.all(e15)), s2(s12);
        }
        this._expressionAttributes = l5, this._graphicExpressionAttributes = { ...o5.attributes, ...l5 }, this._set("formattedAttributes", this._createFormattedAttributes(t5)), this._set("title", this._compileTitle(e14)), this._set("lastEditInfo", this._compileLastEditInfo() || null), this._set("content", this._compileContent(t5) || null);
      } catch (c14) {
  ...
  _createMediaFormattedAttributes({ contentElement: e14, contentElementIndex: t5, formattedAttributes: i11 }) {
    ...
    i11.content[t5] = se({ fieldInfos: s12?.fieldInfos, graphic: o5, attributes: { ...l5, ...e14.attributes }, layer: a7, fieldInfoMap: n13, relatedInfos: r7, timeZone: p10 });
  }
  _createFieldsFormattedAttributes({ contentElement: e14, contentElementIndex: t5, formattedAttributes: i11 }) {
    if (e14.fieldInfos) {
      const { graphic: s12, relatedInfos: o5, _sourceLayer: r7, _fieldInfoMap: a7, _graphicExpressionAttributes: n13, timeZone: l5 } = this;
      i11.content[t5] = se({ fieldInfos: e14.fieldInfos, graphic: s12, attributes: { ...n13, ...e14.attributes }, layer: r7, fieldInfoMap: a7, relatedInfos: o5, timeZone: l5 });
    }
  }
  _createFormattedAttributes(e14) {
    const { _effectivePopupTemplate: t5, graphic: i11, relatedInfos: s12, _sourceLayer: o5, _fieldInfoMap: r7, _graphicExpressionAttributes: a7, timeZone: n13 } = this, l5 = t5?.fieldInfos, p10 = { global: se({ fieldInfos: l5, graphic: i11, attributes: a7, layer: o5, fieldInfoMap: r7, relatedInfos: s12, timeZone: n13 }), content: [] };
    return Array.isArray(e14) && e14.forEach(((e15, t6) => {
      "fields" === e15.type && this._createFieldsFormattedAttributes({ contentElement: e15, contentElementIndex: t6, formattedAttributes: p10 }), "media" === e15.type && this._createMediaFormattedAttributes({ contentElement: e15, contentElementIndex: t6, formattedAttributes: p10 });
    })), p10;
  }
  _checkForRelatedFeatures(e14) {
    const { graphic: t5, _effectivePopupTemplate: i11 } = this;
    return this._queryRelatedInfos(t5, oe(i11), e14);
  }
  async _queryRelatedInfos(e14, t5, i11) {
    ...
    if (!a7?.length) return;
    t5.forEach(((e15) => this._configureRelatedInfo(e15, r7)));
    const n13 = await v4({ relatedInfos: s12, layer: r7 }, i11);
    Object.keys(n13).forEach(((e15) => {
      const t6 = s12.get(e15.toString()), i12 = n13[e15]?.value;
      t6 && i12 && (t6.layerInfo = i12.data);
    }));
  ...
  _configureRelatedInfo(e14, t5) {
    ...
    if (!o5) return;
    const a7 = i11.get(o5.toString()) || b4(o5, t5);
...
var n12 = (n13) => {
  let i11 = class extends n13 {
    constructor() {
      super(...arguments), this.renderNodeContent = (e14) => e8(e14) && !e14.destroyed ? n2("div", { class: t4.contentNode, key: e14 }, e14.render()) : e14 instanceof HTMLElement ? n2("div", { afterCreate: this._attachToNode, bind: e14, class: t4.contentNode, key: e14 }) : o3(e14) ? n2("div", { afterCreate: this._attachToNode, bind: e14.domNode, class: t4.contentNode, key: e14 }) : null;
    }
    _attachToNode(e14) {
      const o5 = this;
      e14.appendChild(o5);
...
var F8 = class extends n12(O) {
  constructor(e14, t5) {
    super(e14, t5), this._contentWidgets = [], this.flowType = "feature", this.flowItems = null, this.headingLevel = 2, this.messages = null, this.messagesCommon = null, this.visibleElements = { ...b8 }, this.viewModel = new ne2();
  }
  initialize() {
    this.addHandles(l((() => this.viewModel?.contentViewModels), (() => this._setupContentWidgets()), h2));
  }
  loadDependencies() {
    return c3({ notice: () => import("./calcite-notice-I3FL54AY.js"), loader: () => import("./calcite-loader-K4VGO2P2.js") });
  }
  destroy() {
  ...
  _renderError() {
    const { messagesCommon: e14, messages: t5, visibleElements: s12 } = this;
    return n2("calcite-notice", { icon: "exclamation-mark-circle", kind: "danger", open: true, scale: "s" }, s12.title ? n2("div", { key: "error-title", slot: "title" }, e14.errorMessage) : null, n2("div", { key: "error-message", slot: "message" }, t5.loadingError));
  }
  _renderLoading() {
  ...
  _renderAttachments(e14) {
    ...
    const { state: s12, attachmentInfos: i11 } = t5.viewModel;
    return "loading" === s12 || i11.length > 0 ? n2("div", { class: this.classes(t4.contentElement), key: this._buildKey("attachments-element", e14) }, t5.render()) : null;
  }
  ...
  _renderCustom(e14, t5) {
    const { creator: s12 } = e14, i11 = this._contentWidgets[t5];
    return !i11 || i11.destroyed ? null : s12 ? n2("div", { class: t4.contentElement, key: this._buildKey("custom-element", t5) }, i11.render()) : null;
  }
  _renderFields(e14) {
    const t5 = this._contentWidgets[e14];
  ...
  _renderLastEditInfo() {
    const { visibleElements: e14, messages: t5 } = this, { lastEditInfo: s12 } = this.viewModel;
    if (!s12 || !e14.lastEditedInfo) return null;
    const { date: i11, user: n13 } = s12, o5 = "edit" === s12.type ? n13 ? t5.lastEditedByUser : t5.lastEdited : n13 ? t5.lastCreatedByUser : t5.lastCreated, r7 = s3(o5, { date: i11, user: n13 });
    return n2("div", { class: this.classes(t4.lastEditedInfo, t4.contentElement), key: "edit-info-element" }, r7);
  }
  _renderText(e14, t5) {
    const s12 = e14.text, i11 = this._contentWidgets[t5];
    return !i11 || i11.destroyed ? null : s12 ? n2("div", { class: this.classes(t4.contentElement, t4.text), key: this._buildKey("text-element", t5) }, i11.render()) : null;
  }
  _buildKey(e14, ...t5) {
    return `${e14}__${this.viewModel?.graphic?.uid || "0"}-${t5.join("-")}`;
  }
  ...
  _setupContentWidgets() {
    this._destroyContentWidgets();
    const { headingLevel: e14, visibleElements: t5, flowItems: s12, viewModel: i11 } = this, n13 = i11?.content, { contentViewModels: o5 } = i11;
    if (Array.isArray(n13)) n13.forEach(((n14, r7) => {
      if ("attachments" === n14.type && (this._contentWidgets[r7] = new h4({ displayType: n14.displayType, headingLevel: t5.title && e14 < 6 ? e14 + 1 : e14, viewModel: o5[r7] })), "fields" === n14.type && (this._contentWidgets[r7] = new c10({ viewModel: o5[r7] })), "media" === n14.type && (this._contentWidgets[r7] = new T3({ viewModel: o5[r7] })), "text" === n14.type && (this._contentWidgets[r7] = new l2({ viewModel: o5[r7] })), "custom" === n14.type && (this._contentWidgets[r7] = new l2({ viewModel: o5[r7] })), "expression" === n14.type && (this._contentWidgets[r7] = new g4({ viewModel: o5[r7] })), "relationship" === n14.type) {
        const e15 = new M4({ flowItems: s12, featureVisibleElements: t5, viewModel: o5[r7] });
      ...
      if ("utility-network-associations" === n14.type) {
        const e15 = async (e16) => {
          ...
          const { default: l5 } = await import("./FeatureUtilityNetworkAssociationList-ZY4EZZ3I.js"), d10 = new l5({ viewModel: n16, parentFeatureViewModel: i11, listType: o6, title: r8, featureVisibleElements: t5, description: i11.title, flowItems: s12 });
          s12.push(d10);
        }, n15 = new v8({ flowItems: s12, onSelectAssociationType: e15, parentFeatureViewModel: i11, featureVisibleElements: t5, viewModel: o5[r7] });
...
//# sourceMappingURL=chunk-4VGXYK4J.js.map
