...
import "./chunk-AWRQ7HIV.js";
import {
  S,
  b as b5
} from "./chunk-ZQI7O3XC.js";
import "./chunk-IPOZ4KSG.js";
import {
  c as c4
...
var p8 = class extends g6 {
  constructor(r18, o14) {
    super(r18, o14, new t6(b7, (() => import("./LineCallout.glsl-7KMOL23T.js"))));
  }
...
var x = new e2(Array, ((e22) => k(e22, Q)), null, 10, 5);
var v3 = u2();
var A7 = class {
  get labelLayers() {
...
var p10 = class extends r13 {
  ...
  async doLoad(e22) {
    ...
    const i12 = [];
    if (!u14) {
      const { make: e23 } = await import("./Graphics3DSymbolLayerFactory-ILKVJAI4.js");
      u14 = e23;
    }
...
var s12 = class extends p10 {
  ...
  async doLoad(o14) {
    const a15 = this._calloutSymbolLayer ? _2(this._calloutSymbolLayer.load()) : null;
    try {
...
var He = (_a = class extends b2 {
  ...
  computeAttachmentOrigin(e22, t14) {
    ...
    return s17 > 1 && g2(Ye, Ye, 1 / s17), new _({ x: Ye[0], y: Ye[1], z: Ye[2], spatialReference: t14 });
  }
  ...
  async rendererChange(e22) {
    if (this._rendererChangeAbortController = e3(this._rendererChangeAbortController), e22 !== this.currentRenderer) if (this._validateRenderer(e22), null == e22 && this._currentRendererChange(null, false), s10(e22)) if (e22?.arcadeRequired) {
...
//# sourceMappingURL=GraphicsLayerView3D-TBSV45AW.js.map
