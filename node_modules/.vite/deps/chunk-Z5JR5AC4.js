...
import {
  V as V3,
  k as k3
} from "./chunk-UBWDHAMB.js";
import {
  c as c2
} from "./chunk-V76HCURU.js";
import {
  n as n4
} from "./chunk-4454H4I4.js";
import {
  t as t4
} from "./chunk-ZOFBCVIZ.js";
import {
  i as i3
...
import {
  t as t3
} from "./chunk-YYJUS4ES.js";
import {
  F
} from "./chunk-INBJCANA.js";
import {
  t as t2
} from "./chunk-K5CV62SX.js";
import {
  e as e3
} from "./chunk-X7BBDXEB.js";
import {
  d as d2
} from "./chunk-Q5GY6UMH.js";
import {
  o as o2
} from "./chunk-QRAOU7FG.js";
import {
  c
} from "./chunk-WTRQG74G.js";
import {
  a as a6
} from "./chunk-TLOYHNR5.js";
import {
  s as s3
} from "./chunk-RBZ7J7WY.js";
import {
  a as a7
} from "./chunk-CJNDN62O.js";
import {
  p as p4
} from "./chunk-KH7RXDTS.js";
import {
  A as A2,
  l as l2
} from "./chunk-CS4Z5TZZ.js";
import {
  c as c3
} from "./chunk-3L2HNPHQ.js";
import {
  u as u3
} from "./chunk-OJDDFCQZ.js";
import {
  p as p5
} from "./chunk-HSP5WUFF.js";
import {
  e as e2
...
var _ = 0;
var T3 = class extends p2.LoadableMixin(m3.EsriPromiseMixin(V)) {
  constructor(e5) {
...
r([n({ Type: d, ensureType: w(d) })], T3.prototype, "itemType", void 0), r([m()], T3.prototype, "type", void 0), r([m({ constructOnly: true })], T3.prototype, "layer", void 0), r([m({ readOnly: true })], T3.prototype, "_workerGeometryType", null), r([m()], T3.prototype, "sourceJSON", void 0), T3 = r([a2("esri.layers.graphics.sources.MemorySource")], T3);
...
var Xe = class extends k3(d2(c(n5(F(a6(p3(p4(c3(e3(t(f2(l(b3(j2(S(e2(i3(a5.ClonableMixin(h2))))))))))))))))))) {
  constructor(...e5) {
    super(...e5), this.attributeTableTemplate = null, this.charts = null, this.copyright = null, this.displayField = null, this.dynamicDataSource = null, this.fields = null, this.fieldsIndex = null, this.formTemplate = null, this.fullExtent = null, this.geometryType = null, this.hasM = void 0, this.hasZ = void 0, this.infoFor3D = null, this.isTable = false, this.labelsVisible = true, this.labelingInfo = null, this.legendEnabled = true, this.objectIdField = null, this.operationalLayerType = "ArcGISFeatureLayer", this.outFields = null, this.path = null, this.popupEnabled = true, this.popupTemplate = null, this.resourceInfo = null, this.screenSizePerspectiveEnabled = true, this.spatialReference = f.WGS84, this.subtypeCode = null, this.supportedSourceTypes = /* @__PURE__ */ new Set(["Feature Layer", "Oriented Imagery Layer", "Table", "Catalog Layer"]), this.templates = null, this.timeInfo = null, this.title = null, this.sublayerTitleMode = "item-title", this.type = "feature", this.typeIdField = null, this.types = null, this.visible = true, this._debouncedSaveOperations = k((async (e6, t5, r4) => {
      const { save: i4, saveAs: o4 } = await import("./featureLayerUtils-N2TLO4UZ.js");
      switch (e6) {
        case A3.SAVE:
          return i4(this, t5);
        case A3.SAVE_AS:
  ...
  castSource(e5) {
    return e5 ? Array.isArray(e5) || e5 instanceof V ? new T3({ layer: this, items: e5 }) : e5 : null;
  }
  readSource(e5, t5) {
  ...
  async createGraphicsSource(e5) {
    ...
    const { default: t5 } = await h(import("./FeatureLayerSource-BEFO35FT.js"), e5);
  ...
  async queryTopFeatures(e5, t5) {
    ...
    const o4 = await import("./TopFeaturesQuery-4A2ZZXX6.js"), a8 = await r4.queryTopFeatures(o4.default.from(e5), t5);
  ...
  async queryAttributeBins(e5, t5) {
    ...
    ae(e5, i4, Ze);
    const o4 = await import("./AttributeBinsQuery-UWLBSCG4.js"), a8 = await r4.queryAttributeBins(o4.default.from(e5), t5);
    if (a8.features) for (const s5 of a8.features) s5.layer = s5.sourceLayer = this;
    return a8;
  }
  async queryTopObjectIds(e5, t5) {
    ...
    const o4 = await import("./TopFeaturesQuery-4A2ZZXX6.js");
...
r([m({ clonable: false, readOnly: true })], Xe.prototype, "_titleCreator", null), r([m(I3)], Xe.prototype, "attributeTableTemplate", void 0), r([o("service", "capabilities")], Xe.prototype, "readCapabilities", null), r([m({ json: { origins: { "web-scene": { write: false } }, write: true } })], Xe.prototype, "charts", void 0), r([m({ readOnly: true })], Xe.prototype, "createQueryVersion", null), r([m({ json: { read: { source: "layerDefinition.copyrightText" } } })], Xe.prototype, "copyright", void 0), r([m({ json: { read: { source: "layerDefinition.displayField" } } })], Xe.prototype, "displayField", void 0), r([m({ types: x, readOnly: true })], Xe.prototype, "defaultSymbol", void 0), r([m({ type: R })], Xe.prototype, "dynamicDataSource", void 0), r([m({ type: Boolean })], Xe.prototype, "editingEnabled", null), r([o(["portal-item", "web-scene"], "editingEnabled", ["layerDefinition.capabilities"])], Xe.prototype, "readEditingEnabled", null), r([o("web-map", "editingEnabled", ["capabilities", "layerDefinition.capabilities"])], Xe.prototype, "readEditingEnabledFromWebMap", null), r([r2(["portal-item", "web-scene"], "editingEnabled", { "layerDefinition.capabilities": { type: String } })], Xe.prototype, "writeEditingEnabled", null), r([r2("web-map", "editingEnabled", { capabilities: { type: String }, "layerDefinition.capabilities": { type: String } })], Xe.prototype, "writeEditingEnabledToWebMap", null), r([m({ readOnly: true })], Xe.prototype, "effectiveEditingEnabled", null), r([m({ clonable: false, readOnly: true })], Xe.prototype, "featureTitleFields", null), r([m({ ...ze.fields, json: { read: { source: "layerDefinition.fields" }, origins: { service: { name: "fields" }, "web-map": { write: { target: "layerDefinition.fields", overridePolicy: Ke } } } } })], Xe.prototype, "fields", void 0), r([m(ze.fieldsIndex)], Xe.prototype, "fieldsIndex", void 0), r([m({ type: V3, json: { name: "formInfo", write: true, origins: { "web-scene": { read: false, write: false } } } })], Xe.prototype, "formTemplate", void 0), r([m({ json: { read: { source: "layerDefinition.extent" } } })], Xe.prototype, "fullExtent", void 0), r([m({ json: { origins: { "web-map": { write: { target: "layerDefinition.geometryType", overridePolicy: Ke, writer(e5, t5, r4) {
  const i4 = e5 ? j.toJSON(e5) : null;
  i4 && e(r4, i4, t5);
} } } }, read: { source: "layerDefinition.geometryType", reader: j.read } } })], Xe.prototype, "geometryType", void 0), r([m({ json: { read: { source: "layerDefinition.hasM" } } })], Xe.prototype, "hasM", void 0), r([m({ json: { read: { source: "layerDefinition.hasZ" } } })], Xe.prototype, "hasZ", void 0), r([m(u5)], Xe.prototype, "id", void 0), r([m({ readOnly: true, json: { origins: { service: { read: true } }, read: false } })], Xe.prototype, "infoFor3D", void 0), r([m({ json: { origins: { "web-map": { write: { target: "layerDefinition.type" } } } } })], Xe.prototype, "isTable", void 0), r([o("service", "isTable", ["type", "geometryType"]), o("isTable", ["layerDefinition.type", "layerDefinition.geometryType"])], Xe.prototype, "readIsTable", null), r([r2("web-map", "isTable")], Xe.prototype, "writeIsTable", null), r([m(p7)], Xe.prototype, "labelsVisible", void 0), r([m({ type: [A2], json: { origins: { service: { name: "drawingInfo.labelingInfo", read: l2, write: false } }, name: "layerDefinition.drawingInfo.labelingInfo", read: l2, write: { layerContainerTypes: a4 } } })], Xe.prototype, "labelingInfo", void 0), r([m((() => {
  const e5 = a(b2);
  return e5.json.origins["portal-item"] = { write: { target: "layerDefinition.drawingInfo.transparency", writer(e6, t5, r4) {
    e(r4, n3(e6), t5);
  } } }, e5;
})())], Xe.prototype, "opacity", void 0), r([m(d3)], Xe.prototype, "legendEnabled", void 0), r([m({ type: ["show", "hide"], json: (() => {
  const e5 = a(T2.json);
  return e5.origins["portal-item"] = { read: false, write: false }, e5;
})() })], Xe.prototype, "listMode", void 0), r([o("globalIdField", ["layerDefinition.globalIdField", "layerDefinition.fields"])], Xe.prototype, "readGlobalIdField", null), r([m({ json: { origins: { "web-map": { write: { target: "layerDefinition.objectIdField", overridePolicy: Ke } } } } })], Xe.prototype, "objectIdField", void 0), r([o("objectIdField", ["layerDefinition.objectIdField", "layerDefinition.fields"])], Xe.prototype, "readObjectIdField", null), r([m({ type: ["ArcGISFeatureLayer"], json: { write: { target: "layerType", ignoreOrigin: true, layerContainerTypes: a4 } } })], Xe.prototype, "operationalLayerType", void 0), r([m(ze.outFields)], Xe.prototype, "outFields", void 0), r([m({ readOnly: true })], Xe.prototype, "parsedUrl", null), r([m({ type: String, json: { origins: { "web-scene": { read: true, write: true } }, read: false } })], Xe.prototype, "path", void 0), r([m(l3)], Xe.prototype, "popupEnabled", void 0), r([m({ type: q, json: { name: "popupInfo", write: true } })], Xe.prototype, "popupTemplate", void 0), r([m({ readOnly: true })], Xe.prototype, "defaultPopupTemplate", null), r([m({ types: m5, json: { origins: { service: { write: { target: "drawingInfo.renderer", enabled: false } }, "web-scene": { types: u2, name: "layerDefinition.drawingInfo.renderer", write: { layerContainerTypes: a4, overridePolicy: (e5, t5, r4) => ({ ignoreOrigin: r4?.writeLayerSchema, layerContainerTypes: a4 }) } } }, write: { target: "layerDefinition.drawingInfo.renderer", overridePolicy: (e5, t5, r4) => ({ ignoreOrigin: r4?.writeLayerSchema, layerContainerTypes: a4 }) } } })], Xe.prototype, "renderer", null), r([o("service", "renderer", ["drawingInfo.renderer", "defaultSymbol"]), o("renderer", ["layerDefinition.drawingInfo.renderer", "layerDefinition.defaultSymbol"])], Xe.prototype, "readRenderer", null), r([m()], Xe.prototype, "resourceInfo", void 0), r([m((() => {
  const e5 = a(s4);
  return e5.json.origins["portal-item"] = { read: false, write: false }, e5;
})())], Xe.prototype, "screenSizePerspectiveEnabled", void 0), r([m({ clonable: false })], Xe.prototype, "source", null), r([s2("source")], Xe.prototype, "castSource", null), r([o("portal-item", "source", ["featureSet"]), o("web-map", "source", ["featureSet"])], Xe.prototype, "readSource", null), r([m({ json: { read: { source: "layerDefinition.extent.spatialReference" } } })], Xe.prototype, "spatialReference", void 0), r([m({ type: Number })], Xe.prototype, "subtypeCode", void 0), r([m({ type: [a7] })], Xe.prototype, "templates", void 0), r([o("templates", ["editFieldsInfo", "creatorField", "editorField", "templates"])], Xe.prototype, "readTemplates", null), r([m({ type: u3 })], Xe.prototype, "timeInfo", void 0), r([m()], Xe.prototype, "title", void 0), r([o("service", "title", ["name"]), o("portal-item", "title", ["layerDefinition.title", "layerDefinition.name", "title"])], Xe.prototype, "readTitle", null), r([o("web-map", "title", ["layerDefinition.name", "title"])], Xe.prototype, "readTitleFromWebMap", null), r([m({ type: String })], Xe.prototype, "sublayerTitleMode", void 0), r([m({ json: { read: false } })], Xe.prototype, "type", void 0), r([m({ type: String })], Xe.prototype, "typeIdField", void 0), r([o("service", "typeIdField"), o("typeIdField", ["layerDefinition.typeIdField"])], Xe.prototype, "readTypeIdField", null), r([m({ type: [n4] })], Xe.prototype, "types", void 0), r([o("service", "types", ["types"]), o("types", ["layerDefinition.types"])], Xe.prototype, "readTypes", null), r([m({ type: Boolean, json: { origins: { "portal-item": { write: { target: "layerDefinition.defaultVisibility", layerContainerTypes: a4 } } } } })], Xe.prototype, "visible", void 0), r([o("portal-item", "visible", ["visibility", "layerDefinition.defaultVisibility"])], Xe.prototype, "readVisible", null), Xe = r([a2("esri.layers.FeatureLayer")], Xe);

export {
  Xe
};
//# sourceMappingURL=chunk-Z5JR5AC4.js.map
