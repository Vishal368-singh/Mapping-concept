...
import {
  ...
  disconnectForm,
  submitForm
} from "./chunk-TK5C4WO7.js";
import {
  connectLabel,
  disconnectLabel
} from "./chunk-CJZ47F6B.js";
...
var groupItemSelector = "calcite-autocomplete-item-group";
var itemSelector = "calcite-autocomplete-item";
var _Autocomplete = class _Autocomplete extends LitElement {
  constructor() {
    super();
    this.guid = guid();
    ...
    this.getAllItemsDebounced = debounce_default(this.getAllItems, 0);
  ...
  willUpdate(changes) {
    ...
    if (changes.has("inputValue") && (this.hasUpdated || this.inputValue)) {
      this.inputValueMatchPattern = this.inputValue && new RegExp(`(${escapeRegExp_default(this.inputValue)})`, "i");
      this.updateItems();
      this.updateGroups();
...
@esri/calcite-components/dist/components/calcite-autocomplete/customElement.js:
  ...
  v3.2.1 *)
*/
//# sourceMappingURL=calcite-autocomplete-7AK36GMD.js.map
