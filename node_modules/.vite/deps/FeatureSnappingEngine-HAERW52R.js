...
var P = class extends b {
  ...
  _loadSourceModule(e2) {
    ...
    switch (e2) {
      case "featureService":
        return t.addPromise(import("./FeatureServiceSnappingSource-NI4ZFGRC.js"));
      case "featureCollection":
        return t.addPromise(import("./FeatureCollectionSnappingSource-NLREBVKS.js"));
      case "graphics":
      case "notes":
        return t.addPromise(import("./GraphicsSnappingSource-HVGAR4IZ.js"));
      case "scene":
        return t.addPromise(import("./SceneLayerSnappingSource-GBTINQEB.js"));
    }
  }
  get test() {
  }
...
//# sourceMappingURL=FeatureSnappingEngine-HAERW52R.js.map
