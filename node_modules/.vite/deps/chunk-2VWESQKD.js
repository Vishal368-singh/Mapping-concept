import {
  o as o2
} from "./chunk-JHCRE356.js";
import {
  n as n4
} from "./chunk-JJYKBE7J.js";
import {
  c as c2
  ...
  let b = class extends f5 {
    ...
    async fetchSublayerInfo(e2, t2) {
      ...
      if (this?.portalItem && "tile" === this.type && "map-layer" === s5?.type && a3(this.portalItem) && e2.originIdOf("url") < e.SERVICE) {
        ...
        r5 && (e2.url = V2(r5.url, s5.mapLayerId.toString()), e2.layerItemId = r5.itemId);
      }
      const { url: i4 } = e2;
      let a4;
    ...
    async _fetchAllLayersAndTablesFromService(e2, i4) {
      ...
      const a4 = p(e2), p5 = u(this._allLayersAndTablesMap, a4?.url.path, (() => H(V2(a4?.url.path, "/layers"), { responseType: "json", query: { f: "json", ...this.customParameters, token: this.apiKey } }).then(((e3) => {
...
var ae = (_a = class extends S(n3.IdentifiableMixin(p2)) {
  ...
  async createFeatureLayer() {
    ...
    const e2 = (await import("./FeatureLayer-MXUCWYAK.js")).default, { layer: r5, url: t2 } = this;
    let i4;
...
var m5 = (m6) => {
  ...
  return r([m2({ readOnly: true })], E.prototype, "allSublayers", void 0), r([m2({ readOnly: true, type: V.ofType(ae) })], E.prototype, "serviceSublayers", void 0), r([m2({ value: null, type: f4, json: { read: false, write: { allowNull: true, ignoreOrigin: true } } })], E.prototype, "sublayers", void 0), r([m2({ readOnly: true })], E.prototype, "sublayersSourceJSON", void 0), r([m2({ type: f4, json: { read: { source: "tables" } } })], E.prototype, "subtables", void 0), E = r([a2("esri.layers.mixins.SublayersOwner")], E), E;
};
...
//# sourceMappingURL=chunk-2VWESQKD.js.map
