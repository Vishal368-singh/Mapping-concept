...
r([m()], p2.prototype, "categories", void 0), r([m()], p2.prototype, "disableExtraQuery", void 0), r([m({ type: z })], p2.prototype, "extent", void 0), r([m()], p2.prototype, "filter", void 0), r([m()], p2.prototype, "num", void 0), r([m()], p2.prototype, "query", void 0), r([m()], p2.prototype, "sortField", void 0), r([m()], p2.prototype, "sortOrder", null), r([m()], p2.prototype, "start", void 0), p2 = u3 = r([a2("esri.portal.PortalQueryParams")], p2);
...
r([m()], u4.prototype, "access", void 0), r([m({ type: Date })], u4.prototype, "created", void 0), r([m()], u4.prototype, "description", void 0), r([m()], u4.prototype, "id", void 0), r([m()], u4.prototype, "isInvitationOnly", void 0), r([m({ type: Date })], u4.prototype, "modified", void 0), r([m()], u4.prototype, "owner", void 0), r([m()], u4.prototype, "portal", void 0), r([m()], u4.prototype, "snippet", void 0), r([m()], u4.prototype, "sortField", void 0), r([m()], u4.prototype, "sortOrder", void 0), r([m()], u4.prototype, "sourceJSON", void 0), r([m()], u4.prototype, "tags", void 0), r([m()], u4.prototype, "thumbnail", void 0), r([m({ readOnly: true })], u4.prototype, "thumbnailUrl", null), r([m()], u4.prototype, "title", void 0), r([m({ readOnly: true })], u4.prototype, "url", null), u4 = l3 = r([a2("esri.portal.PortalGroup")], u4);
...
r([m({ type: Date })], p3.prototype, "created", void 0), r([m()], p3.prototype, "id", void 0), r([m()], p3.prototype, "portal", void 0), r([m()], p3.prototype, "title", void 0), r([m({ readOnly: true })], p3.prototype, "url", null), r([m()], p3.prototype, "username", void 0), p3 = r([a2("esri.portal.PortalFolder")], p3);
...
var u5 = n3 = class extends l2 {
  ...
  async fetchItems(t2) {
    ...
    const { default: r2 } = await import("./PortalItem-2LZYCZY7.js"), o3 = { folders: false, inRecycleBin: !!t2.inRecycleBin || null, foldersContent: !(t2.folder || !t2.includeSubfolderItems) || null, num: t2.num || 10, start: t2.start || 1, sortField: t2.sortField || "created", sortOrder: t2.sortOrder || "asc" }, s5 = await this.portal.request(e2, { query: o3 });
    let l4;
...
var M;
var U;
var Q = { PortalGroup: () => Promise.resolve({ default: u4 }), PortalItem: () => import("./PortalItem-2LZYCZY7.js"), PortalUser: () => Promise.resolve({ default: u5 }) };
var _a;
var C = (_a = class extends l2.JSONSupportMixin(p) {
  ...
  load(e2) {
    const t2 = import("./Basemap-YLO2GHCG.js").then((({ default: t3 }) => {
      s3(e2), U = t3;
  ...
  async createElevationLayers() {
    await this.load();
    const e2 = this._getHelperService("defaultElevationLayers"), t2 = (await import("./ElevationLayer-Y2Z2Q3FL.js")).default;
  ...
  queryPortal(e2, t2, r2, o3) {
    ...
    return r2 && Q[r2] ? Q[r2]().then((({ default: e3 }) => (s3(o3), i3(e3)))) : i3();
  }
  signIn() {
    ...
    if (this.authMode === M.AUTH_MODE_ANONYMOUS || this.authMode === M.AUTH_MODE_NO_PROMPT && !s4) return Promise.reject(new s2("portal:invalid-auth-mode", `Current "authMode"' is "${this.authMode}"`));
    ...
    return s4 ? s4.getCredential(this.restUrl, { prompt: this.authMode !== M.AUTH_MODE_NO_PROMPT }).then(((t2) => e2(t2))) : e2(this.credential);
  }
  normalizeUrl(e2) {
...
//# sourceMappingURL=chunk-YXZLRZNZ.js.map
